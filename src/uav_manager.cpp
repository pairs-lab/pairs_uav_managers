...
class UavManager : public pairs_lib::Node {
...
public:
  ...
  pairs_msgs::msg::HwApiCapabilities hw_api_capabilities_;

  // | ----------------------- subscribers ---------------------- |

  pairs_lib::SubscriberHandler<pairs_msgs::msg::ControllerDiagnostics>        sh_controller_diagnostics_;
  pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>                     sh_odometry_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::EstimationDiagnostics>        sh_estimation_diagnostics_;
  ...
  pairs_lib::SubscriberHandler<std_msgs::msg::Float64>                      sh_throttle_;
  ...
  pairs_lib::SubscriberHandler<pairs_msgs::msg::GainManagerDiagnostics>       sh_gains_diag_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::ConstraintManagerDiagnostics> sh_constraints_diag_;
  pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>                 sh_hw_api_gnss_;
  ...
  // service servers
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>             ss_takeoff_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>             ss_land_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>             ss_land_home_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv> ss_land_there_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>             ss_midair_activation_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>             ss_min_height_check_;

  // service callbacks
  pairs_lib::Task<bool> callbackTakeoff(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                      const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackLand(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                   const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackLandHome(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                       const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackLandThere(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                        const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);

  // service clients
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::Vec1>                sch_takeoff_;
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>             sch_ehover_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>             sch_control_callbacks_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv> sch_emergency_reference_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>             sch_arm_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>             sch_odometry_callbacks_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>             sch_ungrip_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>             sch_toggle_control_output_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>             sch_offboard_;

  // service client wrappers
  pairs_lib::Task<bool> takeoffSrv(void);
  pairs_lib::Task<bool> switchTrackerSrv(const std::string &tracker);
  pairs_lib::Task<bool> switchControllerSrv(const std::string &controller);
  pairs_lib::Task<bool> landSrv(void);
  pairs_lib::Task<bool> elandSrv(void);
  pairs_lib::Task<bool> ehoverSrv(void);
  pairs_lib::Task<void> disarmSrv(void);
  pairs_lib::Task<bool> emergencyReferenceSrv(const pairs_msgs::msg::ReferenceStamped &goal);
  pairs_lib::Task<void> setOdometryCallbacksSrv(const bool &input);
  pairs_lib::Task<void> setControlCallbacksSrv(const bool &input);
  pairs_lib::Task<void> ungripSrv(void);
  pairs_lib::Task<bool> toggleControlOutput(const bool &input);
  pairs_lib::Task<bool> offboardSrv(const bool in);
  ...
  // timer callbacks
  pairs_lib::Task<> timerLanding();
  pairs_lib::Task<> timerTakeoff();
  pairs_lib::Task<> timerMaxHeight();
  pairs_lib::Task<> timerMinHeight();
  pairs_lib::Task<> timerFlightTime();
  pairs_lib::Task<> timerMaxthrottle();
  pairs_lib::Task<> timerDiagnostics();

  // publishers
  pairs_lib::PublisherHandler<pairs_msgs::msg::UavManagerDiagnostics> ph_diag_;
  ...
  pairs_lib::Task<std::tuple<bool, std::string>> landImpl(void);
  pairs_lib::Task<std::tuple<bool, std::string>> landWithDescendImpl(void);
  pairs_lib::Task<std::tuple<bool, std::string>> midairActivationImpl(void);

  // saved takeoff coordinates and allows to land there again
  pairs_msgs::msg::ReferenceStamped land_there_reference_;
  ...
  pairs_lib::quadratic_throttle_model::motor_params_t _throttle_model_;
  ...
  // midair activation
  pairs_lib::Task<>     timerMidairActivation();
  pairs_lib::Task<bool> callbackMidairActivation(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                               const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
...
UavManager::UavManager(rclcpp::NodeOptions options) : pairs_lib::Node("uav_manager", options) {

  node_  = this_node_ptr();
  clock_ = node_->get_clock();

  error_publisher_ = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "UavManager", "main");
...
void UavManager::initialize() {
  ...
  const std::string yaml_prefix = "pairs_uav_managers/uav_manager/";
  ...
  sh_controller_diagnostics_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::ControllerDiagnostics>(shopts, "~/controller_diagnostics_in");
  sh_odometry_               = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, "~/odometry_in", &UavManager::callbackOdometry, this);
  sh_estimation_diagnostics_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::EstimationDiagnostics>(shopts, "~/odometry_diagnostics_in");
  ...
  sh_throttle_               = pairs_lib::SubscriberHandler<std_msgs::msg::Float64>(shopts, "~/throttle_in");
  sh_height_                 = pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped>(shopts, "~/height_in");
  sh_hw_api_status_          = pairs_lib::SubscriberHandler<pairs_msgs::msg::HwApiStatus>(shopts, "~/hw_api_status_in");
  sh_gains_diag_             = pairs_lib::SubscriberHandler<pairs_msgs::msg::GainManagerDiagnostics>(shopts, "~/gain_manager_diagnostics_in");
  sh_constraints_diag_       = pairs_lib::SubscriberHandler<pairs_msgs::msg::ConstraintManagerDiagnostics>(shopts, "~/constraint_manager_diagnostics_in");
  sh_hw_api_gnss_            = pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(shopts, "~/hw_api_gnss_in", &UavManager::callbackHwApiGNSS, this);
  sh_max_height_             = pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped>(shopts, "~/max_height_in");
  sh_tracker_cmd_            = pairs_lib::SubscriberHandler<pairs_msgs::msg::TrackerCommand>(shopts, "~/tracker_cmd_in");

  // | ----------------------- publishers ----------------------- |

  ph_diag_ = pairs_lib::PublisherHandler<pairs_msgs::msg::UavManagerDiagnostics>(node_, "~/diagnostics_out");

  // | --------------------- service servers -------------------- |

  ss_takeoff_ =
      pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/takeoff_in", &UavManager::callbackTakeoff, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_land_ =
      pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/land_in", &UavManager::callbackLand, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_land_home_         = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/land_home_in", &UavManager::callbackLandHome, this,
                                                                                rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_land_there_        = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/land_there_in", &UavManager::callbackLandThere, this,
                                                                                            rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_midair_activation_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/midair_activation_in", &UavManager::callbackMidairActivation, this,
                                                                                rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_min_height_check_  = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
      node_, "~/enable_min_height_check_in", std::bind(&UavManager::callbackMinHeightCheck, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  // | --------------------- service clients -------------------- |

  sch_takeoff_               = pairs_lib::ServiceClientHandler<pairs_msgs::srv::Vec1>(node_, "~/takeoff_out", cbkgrp_sc_);
  sch_land_                  = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/land_out", cbkgrp_sc_);
  sch_eland_                 = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/eland_out", cbkgrp_sc_);
  sch_ehover_                = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/ehover_out", cbkgrp_sc_);
  sch_switch_tracker_        = pairs_lib::ServiceClientHandler<pairs_msgs::srv::String>(node_, "~/switch_tracker_out", cbkgrp_sc_);
  sch_switch_controller_     = pairs_lib::ServiceClientHandler<pairs_msgs::srv::String>(node_, "~/switch_controller_out", cbkgrp_sc_);
  sch_emergency_reference_   = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/emergency_reference_out", cbkgrp_sc_);
  sch_control_callbacks_     = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/enable_callbacks_out", cbkgrp_sc_);
  sch_arm_                   = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/arm_out", cbkgrp_sc_);
  sch_odometry_callbacks_    = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/set_odometry_callbacks_out", cbkgrp_sc_);
  sch_ungrip_                = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/ungrip_out", cbkgrp_sc_);
  sch_toggle_control_output_ = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/toggle_control_output_out", cbkgrp_sc_);
  sch_offboard_              = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/offboard_out", cbkgrp_sc_);
  ...
  profiler_ = pairs_lib::Profiler(node_, "UavManager", _profiler_enabled_);
...
void UavManager::timerHwApiCapabilities() {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerHwApiCapabilities", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<> UavManager::timerLanding() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerLanding");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerLanding", scope_timer_logger_, scope_timer_enabled_);

  auto land_there_reference = pairs_lib::get_mutexed(mutex_land_there_reference_, land_there_reference_);
  ...
  pairs_msgs::msg::ReferenceStamped land_there_current_frame;
  ...
  if (current_state_landing_ == IDLE_STATE) {
    ...
    auto [pos_x, pos_y, pos_z] = pairs_lib::getPosition(*tracker_cmd);
    auto [ref_x, ref_y, ref_z] = pairs_lib::getPosition(land_there_current_frame);

    double pos_heading = tracker_cmd->heading;

    double ref_heading = 0;
    try {
      ref_heading = pairs_lib::getHeading(land_there_current_frame);
    }
    ...
    if (pairs_lib::geometry::dist(vec3_t(pos_x, pos_y, pos_z), vec3_t(ref_x, ref_y, ref_z)) < _landing_tracking_tolerance_translation_ &&
...

      {
        ...
        current_pose.pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
    ...
    if (_landing_tracker_name_ == sh_control_manager_diag_.getMsg()->active_tracker) {
      ...
      if (desired_throttle) {
        ...
        throttle_mass_estimate_ = pairs_lib::quadratic_throttle_model::throttleToForce(_throttle_model_, desired_throttle.value()) / _g_;
...
pairs_lib::Task<> UavManager::timerTakeoff() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerTakeoff");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerTakeoff", scope_timer_logger_, scope_timer_enabled_);
  ...
  if (takingoff_) {
    ...
    if (control_manager_diagnostics->active_tracker != _takeoff_tracker_name_ || !control_manager_diagnostics->tracker_status.have_goal) {
      ...
      auto [odom_x, odom_y, odom_z] = pairs_lib::getPosition(sh_odometry_.getMsg());

      double odom_heading;
      try {
        odom_heading = pairs_lib::getHeading(sh_odometry_.getMsg());
      }
      catch (pairs_lib::AttitudeConverter::GetHeadingException &e) {
        RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "exception caught: '%s'", e.what());
...
pairs_lib::Task<> UavManager::timerMaxHeight() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMaxHeight");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerMaxHeight", scope_timer_logger_, scope_timer_enabled_);
  ...
  auto [odometry_x, odometry_y, odometry_z] = pairs_lib::getPosition(odometry);

  double odometry_heading = 0;
  try {
    odometry_heading = pairs_lib::getHeading(odometry);
  }
  catch (pairs_lib::AttitudeConverter::GetHeadingException &e) {
    RCLCPP_ERROR_THROTTLE(node_->get_logger(), *clock_, 1000, "exception caught: '%s'", e.what());
...
pairs_lib::Task<> UavManager::timerMinHeight() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMinHeight");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerMinHeight", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<> UavManager::timerFlightTime() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerFlightTime");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerFlightTime", scope_timer_logger_, scope_timer_enabled_);

  auto flighttime = pairs_lib::get_mutexed(mutex_flighttime_, flighttime_);

  flighttime += 1.0 / _flighttime_timer_rate_;

  pairs_msgs::msg::Float64 flight_time;
  ...
  pairs_lib::set_mutexed(mutex_flighttime_, flighttime, flighttime_);
}
...
pairs_lib::Task<> UavManager::timerMaxthrottle() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMaxthrottle");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerMaxthrottle", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<> UavManager::timerDiagnostics() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerDiagnostics");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::timerDiagnostics", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::msg::UavManagerDiagnostics diag;
  ...
  if (sh_odometry_.hasMsg()) { // get current position in lat-lon
    ...
    if (got_gps_est || got_rtk_est) {
      ...
      uav_pose.pose = pairs_lib::getPose(odom);
...
pairs_lib::Task<> UavManager::timerMidairActivation() {
...
void UavManager::callbackHwApiGNSS(const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackHwApiGNSS");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "UavManager::callbackHwApiGNSS", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> UavManager::callbackTakeoff([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...

  {
    ...
    if (number_of_takeoffs_ > 0) {
      ...
      auto last_mass_difference = pairs_lib::get_mutexed(mutex_last_mass_difference_, last_mass_difference_);
...
pairs_lib::Task<bool> UavManager::callbackLand([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                             const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> UavManager::callbackLandHome([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                 const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> UavManager::callbackLandThere(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                  const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
  ...
  pairs_msgs::msg::ReferenceStamped reference_in;
...
pairs_lib::Task<bool> UavManager::callbackMidairActivation([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                         const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<std::tuple<bool, std::string>> UavManager::landImpl(void) {
...
pairs_lib::Task<std::tuple<bool, std::string>> UavManager::landWithDescendImpl(void) {
  ...
  if (sh_height_.hasMsg()) {
    ...
    if (height > 0 && height >= _landing_descend_height_ + 1.0) {
...

      {
        ...
        land_there_reference_.reference.heading    = pairs_lib::AttitudeConverter(odometry->pose.pose.orientation).getHeading();
      }
...
pairs_lib::Task<std::tuple<bool, std::string>> UavManager::midairActivationImpl(void) {
...
pairs_lib::Task<void> UavManager::setOdometryCallbacksSrv(const bool &input) {
...
pairs_lib::Task<void> UavManager::setControlCallbacksSrv(const bool &input) {
...
pairs_lib::Task<void> UavManager::ungripSrv(void) {
...
pairs_lib::Task<bool> UavManager::toggleControlOutput(const bool &input) {
...
pairs_lib::Task<bool> UavManager::offboardSrv(const bool in) {
...
pairs_lib::Task<void> UavManager::disarmSrv(void) {
...
pairs_lib::Task<bool> UavManager::switchControllerSrv(const std::string &controller) {
...
pairs_lib::Task<bool> UavManager::switchTrackerSrv(const std::string &tracker) {
...
pairs_lib::Task<bool> UavManager::landSrv(void) {
...
pairs_lib::Task<bool> UavManager::elandSrv(void) {
...
pairs_lib::Task<bool> UavManager::ehoverSrv(void) {
...
pairs_lib::Task<bool> UavManager::takeoffSrv(void) {
...
pairs_lib::Task<bool> UavManager::emergencyReferenceSrv(const pairs_msgs::msg::ReferenceStamped &goal) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::uav_manager::UavManager)
