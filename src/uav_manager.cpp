...
public:
  ...
  pairs_msgs::HwApiCapabilities hw_api_capabilities_;

  // | ----------------------- subscribers ---------------------- |

  pairs_lib::SubscribeHandler<pairs_msgs::ControllerDiagnostics>        sh_controller_diagnostics_;
  pairs_lib::SubscribeHandler<nav_msgs::Odometry>                     sh_odometry_;
  pairs_lib::SubscribeHandler<pairs_msgs::EstimationDiagnostics>        sh_estimation_diagnostics_;
  ...
  pairs_lib::SubscribeHandler<std_msgs::Float64>                      sh_throttle_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::GainManagerDiagnostics>       sh_gains_diag_;
  pairs_lib::SubscribeHandler<pairs_msgs::ConstraintManagerDiagnostics> sh_constraints_diag_;
  pairs_lib::SubscribeHandler<sensor_msgs::NavSatFix>                 sh_hw_api_gnss_;
  ...
  bool callbackLandThere(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res);

  // service clients
  pairs_lib::ServiceClientHandler<pairs_msgs::Vec1>                sch_takeoff_;
  ...
  pairs_lib::ServiceClientHandler<std_srvs::Trigger>             sch_ehover_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool>             sch_control_callbacks_;
  pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv> sch_emergency_reference_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool>             sch_arm_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool>             sch_odometry_callbacks_;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger>             sch_ungrip_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool>             sch_toggle_control_output_;
  ...
  bool ehoverSrv(void);
  void disarmSrv(void);
  bool emergencyReferenceSrv(const pairs_msgs::ReferenceStamped& goal);
  ...
  // publishers
  pairs_lib::PublisherHandler<pairs_msgs::UavManagerDiagnostics> ph_diag_;
  ...
  pairs_msgs::ReferenceStamped land_there_reference_;
...
void UavManager::initialize() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "UavManager");
  ...
  sh_controller_diagnostics_ = pairs_lib::SubscribeHandler<pairs_msgs::ControllerDiagnostics>(shopts, "controller_diagnostics_in");
  sh_odometry_               = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, "odometry_in", &UavManager::callbackOdometry, this);
  sh_estimation_diagnostics_ = pairs_lib::SubscribeHandler<pairs_msgs::EstimationDiagnostics>(shopts, "odometry_diagnostics_in");
  ...
  sh_throttle_               = pairs_lib::SubscribeHandler<std_msgs::Float64>(shopts, "throttle_in");
  sh_height_                 = pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped>(shopts, "height_in");
  sh_hw_api_status_          = pairs_lib::SubscribeHandler<pairs_msgs::HwApiStatus>(shopts, "hw_api_status_in");
  sh_gains_diag_             = pairs_lib::SubscribeHandler<pairs_msgs::GainManagerDiagnostics>(shopts, "gain_manager_diagnostics_in");
  sh_constraints_diag_       = pairs_lib::SubscribeHandler<pairs_msgs::ConstraintManagerDiagnostics>(shopts, "constraint_manager_diagnostics_in");
  sh_hw_api_gnss_            = pairs_lib::SubscribeHandler<sensor_msgs::NavSatFix>(shopts, "hw_api_gnss_in", &UavManager::callbackHwApiGNSS, this);
  sh_max_height_             = pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped>(shopts, "max_height_in");
  sh_tracker_cmd_            = pairs_lib::SubscribeHandler<pairs_msgs::TrackerCommand>(shopts, "tracker_cmd_in");

  // | ----------------------- publishers ----------------------- |

  ph_diag_ = pairs_lib::PublisherHandler<pairs_msgs::UavManagerDiagnostics>(nh_, "diagnostics_out", 1);
  ...
  sch_takeoff_               = pairs_lib::ServiceClientHandler<pairs_msgs::Vec1>(nh_, "takeoff_out");
  sch_land_                  = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "land_out");
  sch_eland_                 = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "eland_out");
  sch_ehover_                = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "ehover_out");
  ...
  sch_emergency_reference_   = pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv>(nh_, "emergency_reference_out");
  sch_control_callbacks_     = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "enable_callbacks_out");
  sch_arm_                   = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "arm_out");
  sch_odometry_callbacks_    = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "set_odometry_callbacks_out");
  sch_ungrip_                = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "ungrip_out");
  sch_toggle_control_output_ = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "toggle_control_output_out");
  sch_offboard_              = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "offboard_out");
  ...
  profiler_ = pairs_lib::Profiler(nh_, "UavManager", _profiler_enabled_);
...
void UavManager::timerHwApiCapabilities(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerHwApiCapabilities", 1.0, 1.0, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerHwApiCapabilities", scope_timer_logger_, scope_timer_enabled_);
...
void UavManager::timerLanding(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerLanding", _landing_timer_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerLanding", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::ReferenceStamped land_there_current_frame;
...
void UavManager::timerTakeoff(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerTakeoff", _takeoff_timer_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerTakeoff", scope_timer_logger_, scope_timer_enabled_);
...
void UavManager::timerMaxHeight(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMaxHeight", _max_height_checking_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerMaxHeight", scope_timer_logger_, scope_timer_enabled_);
...
void UavManager::timerMinHeight(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMinHeight", _min_height_checking_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerMinHeight", scope_timer_logger_, scope_timer_enabled_);
...
void UavManager::timerFlightTime(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerFlightTime", _flighttime_timer_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerFlightTime", scope_timer_logger_, scope_timer_enabled_);

  auto flighttime = pairs_lib::get_mutexed(mutex_flighttime_, flighttime_);

  flighttime += 1.0 / _flighttime_timer_rate_;

  pairs_msgs::Float64 flight_time;
...
void UavManager::timerMaxthrottle(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerMaxthrottle", _maxthrottle_timer_rate_, 0.03, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerMaxthrottle", scope_timer_logger_, scope_timer_enabled_);
...
void UavManager::timerDiagnostics(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerDiagnostics", _maxthrottle_timer_rate_, 0.03, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::timerDiagnostics", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::UavManagerDiagnostics diag;
...
void UavManager::callbackHwApiGNSS(const sensor_msgs::NavSatFix::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("UavManager::callbackHwApiGNSS", scope_timer_logger_, scope_timer_enabled_);
...
bool UavManager::callbackLandThere(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res) {
  ...
  pairs_msgs::ReferenceStamped reference_in;
...
bool UavManager::emergencyReferenceSrv(const pairs_msgs::ReferenceStamped& goal) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_managers::uav_manager::UavManager, nodelet::Nodelet)
