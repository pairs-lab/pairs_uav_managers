...
#include <pairs_msgs/msg/point2_d.hpp>
...
#include <pairs_msgs/srv/set_obstacle_srv.hpp>
#include <pairs_msgs/srv/set_safety_border_srv.hpp>
...
class SafetyAreaManager : public pairs_lib::Node {
...
private:
  ...
  {
    std::vector<std::unique_ptr<pairs_lib::StaticEdgesVisualization>> static_edges;
  ...
  {
    pairs_msgs::msg::WorldOrigin world_origin;
  };

  struct SafetyZoneHandler
  {
    std::shared_ptr<pairs_lib::safety_zone::SafetyZone> safety_zone;
  ...
  std::tuple<bool, bool> isPositionValid(pairs_msgs::msg::UavState);
  ...
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>    ss_point_in_safety_area_3d_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>    ss_point_in_safety_area_2d_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidatePathToPointSrv> ss_path_in_safety_area_3d_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidatePathToPointSrv> ss_path_in_safety_area_2d_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::SetSafetyBorderSrv>     ss_set_safety_border_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>                ss_toggle_safety_area_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>    ss_add_obstacle_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::SetObstacleSrv>         ss_set_obstacle_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetReferenceStampedSrv> ss_get_max_z_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetReferenceStampedSrv> ss_get_min_z_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetBoolSrv>             ss_is_safety_zone_enabled_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>    ss_update_world_origin_;

  // | --------------------- service clients --------------------- |

  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv> sc_set_world_origin_;
  ...
  pairs_lib::PublisherHandler<pairs_msgs::msg::SafetyAreaManagerDiagnostics> ph_diagnostics_;
  ...
  // services
  bool callbackValidatePoint3d(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                               const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  bool callbackValidatePoint2d(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                               const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  bool callbackValidatePathToPoint3d(const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
                                     const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response);
  bool callbackValidatePathToPoint2d(const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
                                     const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response);

  bool callbackSetSafetyBorder(const std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Request>  request,
                               const std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Response> response);
  bool callbackToggleSafetyArea(const std::shared_ptr<std_srvs::srv::SetBool::Request>  request,
                                const std::shared_ptr<std_srvs::srv::SetBool::Response> response);
  bool callbackAddObstacle(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                           const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  bool callbackSetObstacle(const std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Request>  request,
                           const std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Response> response);
  bool callbackGetMaxZ(const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request>  request,
                       const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response> response);
  bool callbackGetMinZ(const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request>  request,
                       const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response> response);
  bool callbackIsSafetyZoneEnabled([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Request> request,
                                   std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Response>                       response);
  bool callbackUpdateWorldOrigin(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                 const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  ...
  std::unique_ptr<pairs_lib::safety_zone::Prism> makePrism(const Eigen::MatrixXd &matrix, const double max_z, const double min_z,
                                                         const std::string &horizontal_frame, const std::string &vertical_frame);
  std::unique_ptr<pairs_lib::safety_zone::Prism> makePrism(const std::vector<pairs_msgs::msg::Point2D> &points, const double max_z, const double min_z,
                                                         const std::string &horizontal_frame, const std::string &vertical_frame);
  // Transform prism
  std::optional<pairs_lib::safety_zone::Prism> transformPrism(const pairs_lib::safety_zone::Prism &prism, const std::string &target_frame);

  std::tuple<bool, std::vector<pairs_lib::safety_zone::Point2d>> transformPoints(const std::vector<pairs_lib::safety_zone::Point2d> &points,
  ...
  bool                                                      initializationFromFile(pairs_lib::ParamLoader &param_loader, const std::string &filename);
  std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> copyExistingObstacles();
  bool                                                      initializationFromMsg(const pairs_msgs::msg::Prism &prism_msg, bool keep_obstacles);
  std::optional<SafetyZoneHandler>                          createSafetyZone(std::unique_ptr<pairs_lib::safety_zone::Prism>            &&border,
                                                                             std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> obstacle_prisms);

  std::tuple<bool, std::string> validateMsg(const pairs_msgs::msg::Prism &prism_msg);

  // Reference validation
  bool   isPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &point);
  bool   isPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &point);
  bool   isPathToPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &from, const pairs_msgs::msg::ReferenceStamped &to);
  bool   isPathToPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &from, const pairs_msgs::msg::ReferenceStamped &to);
  double getMaxZ();
  double getMinZ();
...
SafetyAreaManager::SafetyAreaManager(rclcpp::NodeOptions options) : pairs_lib::Node("safety_area_manager", options) {

  node_  = this_node_ptr();
  clock_ = node_->get_clock();

  error_publisher_ = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "SafetyAreaManager", "main");

  pairs_lib::ParamLoader param_loader(node_, "SafetyAreaManager");
  ...
  sh_gnss_                 = pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(shopts, "~/gnss_in", &SafetyAreaManager::callbackGNSS, this);
...
void SafetyAreaManager::initialize() {
  ...
  param_loader.setPrefix("pairs_uav_managers/safety_area_manager/");
  param_loader.loadParam("status_timer_rate", status_timer_rate_);

  // | ------------------------ profiler ------------------------ |

  profiler_ = pairs_lib::Profiler(node_, "SafetyAreaManager", profiler_enabled_);
  ...
  ph_diagnostics_ = pairs_lib::PublisherHandler<pairs_msgs::msg::SafetyAreaManagerDiagnostics>(node_, "~/diagnostics_out");
  ...
  sh_odometry_ = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, "~/odometry_in", &SafetyAreaManager::callbackOdometry, this);
  sh_max_z_    = pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped>(shopts, "~/max_z_in");

  // | ------------------------ services ------------------------ |
  ss_point_in_safety_area_3d_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
      node_, "~/point_in_safety_area_3d_in",
      [this](std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request> request, std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
        callbackValidatePoint3d(request, response);
      },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_point_in_safety_area_2d_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
  ...
  ss_path_in_safety_area_3d_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidatePathToPointSrv>(
      node_, "~/path_in_safety_area_3d_in",
      [this](std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
             std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response) { callbackValidatePathToPoint3d(request, response); },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_path_in_safety_area_2d_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidatePathToPointSrv>(
      node_, "~/path_in_safety_area_2d_in",
      [this](std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
             std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response) { callbackValidatePathToPoint2d(request, response); },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_set_safety_border_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::SetSafetyBorderSrv>(
      node_, "~/set_safety_border_in",
      [this](std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Request> request, std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Response> response) {
        callbackSetSafetyBorder(request, response);
      },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_toggle_safety_area_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
  ...
  ss_add_obstacle_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
  ...
  ss_set_obstacle_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::SetObstacleSrv>(
      node_, "~/set_obstacle_in",
      [this](std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Request> request, std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Response> response) {
        callbackSetObstacle(request, response);
      },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_get_max_z_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetReferenceStampedSrv>(
      node_, "~/get_max_z_in",
      [this](std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request>  request,
             std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response> response) { callbackGetMaxZ(request, response); },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_get_min_z_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetReferenceStampedSrv>(
      node_, "~/get_min_z_in",
      [this](std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request>  request,
             std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response> response) { callbackGetMinZ(request, response); },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_is_safety_zone_enabled_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetBoolSrv>(
      node_, "~/is_safety_zone_enabled_in",
      [this](std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Request> request, std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Response> response) {
        callbackIsSafetyZoneEnabled(request, response);
      },
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_update_world_origin_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
  ...
  sc_set_world_origin_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/set_world_origin_out", cbkgrp_sc_);
...
void SafetyAreaManager::timerPrerequisites() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerPrerequisites");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "SafetyAreaManager::timerPrerequisites", scope_timer_logger_, scope_timer_enabled_);
...
void SafetyAreaManager::timerStatus() {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "SafetyAreaManager::timerStatus", scope_timer_logger_, scope_timer_enabled_);
    ...
    if (safety_zone_handler_.safety_zone && !safety_zone_handler_.visualization_components.initialized) {
      ...
      if (!transformed_prism) {
        ...
        safety_zone_handler_.visualization_components.static_edges.push_back(
            std::make_unique<pairs_lib::StaticEdgesVisualization>(transformed_prism.value(), _uav_name_, "local_origin", node_, 2));
        ...
        for (const auto &[id, obstacle_ptr] : obstacles) {
          ...
          safety_zone_handler_.visualization_components.static_edges.push_back(
              std::make_unique<pairs_lib::StaticEdgesVisualization>(transformed_obstacle_prism.value(), _uav_name_, "local_origin", node_, 2));
        }
      }
  ...
  if (world_origin_changed_ && current_border.getHorizontalFrame() == "world_origin") {
    ...
    std::vector<pairs_lib::safety_zone::Point2d> new_points;

    // Add offset to border points
    for (auto &point : current_points) {
      new_points.push_back(pairs_lib::safety_zone::Point2d{point.get<0>() + world_origin_offset_x_, point.get<1>() + world_origin_offset_y_});
    }

    auto new_border_prism = std::make_unique<pairs_lib::safety_zone::Prism>(new_points, current_max_z, current_min_z, "world_origin", "world_origin");
    ...
    for (auto &obstacle : existing_obstacles) {
      if (obstacle->getHorizontalFrame() == "world_origin") {
        ...
        std::vector<pairs_lib::safety_zone::Point2d> updated_points;

        for (auto &point : obstacle_points) {
          updated_points.push_back(pairs_lib::safety_zone::Point2d{point.get<0>() + world_origin_offset_x_, point.get<1>() + world_origin_offset_y_});
        }

        *obstacle = pairs_lib::safety_zone::Prism(updated_points, obstacle->getMaxZ(), obstacle->getMinZ(), "world_origin", "world_origin");
      }
    }
...
void SafetyAreaManager::callbackOdometry(const nav_msgs::msg::Odometry::ConstSharedPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "SafetyAreaManager::callbackOdometry", scope_timer_logger_, scope_timer_enabled_);
...
void SafetyAreaManager::callbackGNSS(const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "SafetyAreaManager::callbackGNSS", scope_timer_logger_, scope_timer_enabled_);
...
bool SafetyAreaManager::callbackAddObstacle(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                            const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
  ...
  pairs_msgs::msg::ReferenceStamped point;
  ...
  std::vector<pairs_lib::safety_zone::Point2d> points = {
      pairs_lib::safety_zone::Point2d{2.5 + offset_x, 2.5 + offset_y},
      pairs_lib::safety_zone::Point2d{2.5 + offset_x, -2.5 + offset_y},
      pairs_lib::safety_zone::Point2d{-2.5 + offset_x, -2.5 + offset_y},
      pairs_lib::safety_zone::Point2d{-2.5 + offset_x, 2.5 + offset_y},
  };

  int id = safety_zone_handler_.safety_zone->addObstacle(std::make_unique<pairs_lib::safety_zone::Prism>(points, 5, 0));

  safety_zone_handler_.visualization_components.static_edges.push_back(
      std::make_unique<pairs_lib::StaticEdgesVisualization>(safety_zone_handler_.safety_zone.get(), id, _uav_name_, horizontal_frame, node_, 2));
...
bool SafetyAreaManager::callbackSetObstacle(const std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Request>  request,
                                            const std::shared_ptr<pairs_msgs::srv::SetObstacleSrv::Response> response) {
  ...
  safety_zone_handler_.visualization_components.static_edges.push_back(
      std::make_unique<pairs_lib::StaticEdgesVisualization>(safety_zone_handler_.safety_zone.get(), id, _uav_name_, request->prism.horizontal_frame, node_, 2));
...
bool SafetyAreaManager::callbackSetSafetyBorder(const std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Request>  request,
                                                const std::shared_ptr<pairs_msgs::srv::SetSafetyBorderSrv::Response> response) {
  ...
  if (request->update_world_origin) {
    auto ref_request             = std::make_shared<pairs_msgs::srv::ReferenceStampedSrv::Request>();
...
bool SafetyAreaManager::callbackValidatePoint3d(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
...
bool SafetyAreaManager::callbackValidatePoint2d(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
  if (!is_initialized_) {
    return false;
  }
...
bool SafetyAreaManager::callbackValidatePathToPoint3d(const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
                                                      const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response) {
  ...
  pairs_msgs::msg::ReferenceStamped start, end;
...
bool SafetyAreaManager::callbackValidatePathToPoint2d(const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request>  request,
                                                      const std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Response> response) {
...
bool SafetyAreaManager::callbackGetMaxZ([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request> request,
                                        const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response>                 response) {
...
bool SafetyAreaManager::callbackGetMinZ([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request> request,
                                        const std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Response>                 response) {
...
bool SafetyAreaManager::callbackIsSafetyZoneEnabled([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Request> request,
                                                    const std::shared_ptr<pairs_msgs::srv::GetBoolSrv::Response>                 response) {
  if (!is_initialized_) {
    return false;
  }
...
bool SafetyAreaManager::callbackUpdateWorldOrigin(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                  const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
...
bool SafetyAreaManager::initializationFromFile(pairs_lib::ParamLoader &param_loader, const std::string &filename) {
  ...
  param_loader.loadParam("pairs_uav_managers/world_origin/units", world_origin_units);
  param_loader.loadParam("pairs_uav_managers/world_origin/origin_x", origin_x);
  param_loader.loadParam("pairs_uav_managers/world_origin/origin_y", origin_y);
  param_loader.loadParam("pairs_uav_managers/safety_area_manager/safety_area/enabled", safety_area_enabled);
  param_loader.loadParam("pairs_uav_managers/safety_area_manager/safety_area/horizontal/frame_name", horizontal_frame);
  param_loader.loadParam("pairs_uav_managers/safety_area_manager/safety_area/vertical/frame_name", vertical_frame);
  ...
  // Make border prism
  const Eigen::MatrixXd border_points = param_loader.loadMatrixDynamic2("pairs_uav_managers/safety_area_manager/safety_area/horizontal/points", -1, 2);
  const auto            max_z         = param_loader.loadParam2<double>("pairs_uav_managers/safety_area_manager/safety_area/vertical/max_z");
  const auto            min_z         = param_loader.loadParam2<double>("pairs_uav_managers/safety_area_manager/safety_area/vertical/min_z");
  ...
  std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> obstacles;

  bool obstacles_present = false;

  param_loader.loadParam("pairs_uav_managers/safety_area_manager/safety_area/obstacles/present", obstacles_present);
  ...
  if (obstacles_present) {
    ...
    param_loader.loadParam("pairs_uav_managers/safety_area_manager/obstacles/count", obstacles_count);
    ...
    for (int i = 0; i < obstacles_count; i++) {
      ...
      std::string obstacle_path = "pairs_uav_managers/safety_area_manager/obstacles/obstacle_" + std::to_string(i);
...
std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> SafetyAreaManager::copyExistingObstacles() {
  if (!safety_zone_handler_.safety_zone) {
    return {};
  }

  const auto                                               &obstacles_map = safety_zone_handler_.safety_zone->getObstacles();
  std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> obstacles_copy;
  obstacles_copy.reserve(obstacles_map.size());

  for (const auto &[id, obstacle_ptr] : obstacles_map) {
    obstacles_copy.push_back(std::make_unique<pairs_lib::safety_zone::Prism>(*obstacle_ptr));
  }

  return obstacles_copy;
}

bool SafetyAreaManager::initializationFromMsg(const pairs_msgs::msg::Prism &prism_msg, bool keep_obstacles) {
...
SafetyAreaManager::createSafetyZone(std::unique_ptr<pairs_lib::safety_zone::Prism>            &&border,
                                    std::vector<std::unique_ptr<pairs_lib::safety_zone::Prism>> obstacle_prisms = {}) {

  SafetyZoneHandler safety_zone_handler;
  safety_zone_handler.safety_zone = std::make_shared<pairs_lib::safety_zone::SafetyZone>(std::move(border), std::move(obstacle_prisms));
...
std::tuple<bool, std::string> SafetyAreaManager::validateMsg(const pairs_msgs::msg::Prism &prism_msg) {
...
std::unique_ptr<pairs_lib::safety_zone::Prism> SafetyAreaManager::makePrism(const Eigen::MatrixXd &matrix, const double max_z, const double min_z,
                                                                          const std::string &horizontal_frame, const std::string &vertical_frame) {
  ...
  for (int i = 0; i < matrix.rows(); i++) {
    points.emplace_back(pairs_lib::safety_zone::Point2d{matrix(i, 0), matrix(i, 1)});
  }

  std::unique_ptr<pairs_lib::safety_zone::Prism> prism;
  try {
    prism = std::make_unique<pairs_lib::safety_zone::Prism>(points, max_z, min_z, horizontal_frame, vertical_frame);
  }
...
std::unique_ptr<pairs_lib::safety_zone::Prism> SafetyAreaManager::makePrism(const std::vector<pairs_msgs::msg::Point2D> &points, const double max_z,
  ...
  std::vector<pairs_lib::safety_zone::Point2d> tmp_points;

  tmp_points.reserve(points.size());

  for (const auto &point : points) {
    tmp_points.emplace_back(pairs_lib::safety_zone::Point2d{point.x, point.y});
  }

  std::unique_ptr<pairs_lib::safety_zone::Prism> prism;
  try {
    prism = std::make_unique<pairs_lib::safety_zone::Prism>(tmp_points, max_z, min_z, horizontal_frame, vertical_frame);
  }
  catch (const std::exception &e) {
    RCLCPP_WARN(node_->get_logger(), "Failed to create prism from message: %s", e.what());
    return nullptr;
...
std::optional<pairs_lib::safety_zone::Prism> SafetyAreaManager::transformPrism(const pairs_lib::safety_zone::Prism &prism, const std::string &target_frame) {
  ...
  return pairs_lib::safety_zone::Prism(transformed_border_points, transformed_max_z, transformed_min_z, target_frame, target_frame);
}
...
std::tuple<bool, std::vector<pairs_lib::safety_zone::Point2d>>
SafetyAreaManager::transformPoints(const std::vector<pairs_lib::safety_zone::Point2d> &points, const std::string &from_frame, const std::string &target_frame) {

  std::vector<pairs_lib::safety_zone::Point2d> transformed_points;
  transformed_points.reserve(points.size());
  pairs_msgs::msg::ReferenceStamped reference_tmp;
  ...
  for (const auto &point : points) {
    ...
    if (auto transformed_reference = transformer_->transformSingle(reference_tmp, target_frame)) {
      ...
      transformed_points.emplace_back(pairs_lib::safety_zone::Point2d{reference_tmp.reference.position.x, reference_tmp.reference.position.y});
    } else {
      RCLCPP_WARN(node_->get_logger(), "Could not transform point from %s to %s.", from_frame.c_str(), target_frame.c_str());
      return std::make_tuple(false, std::vector<pairs_lib::safety_zone::Point2d>{});
    }
  }
...
bool SafetyAreaManager::isPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &point) {
...
bool SafetyAreaManager::isPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &point) {
...
bool SafetyAreaManager::isPathToPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &start, const pairs_msgs::msg::ReferenceStamped &end) {

  if (!safety_zone_handler_.safety_zone->safetyZoneEnabled()) {
    return true;
  }

  pairs_msgs::msg::ReferenceStamped start_transformed, end_transformed;
  ...
  pairs_lib::safety_zone::Point2d start_point, end_point;
...
bool SafetyAreaManager::isPathToPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &start, const pairs_msgs::msg::ReferenceStamped &end) {
  ...
  // verify the whole path
  pairs_lib::safety_zone::Point3d start_point, end_point;
  start_point.set<0>(start_transformed.reference.position.x);
  start_point.set<1>(start_transformed.reference.position.y);
...
void SafetyAreaManager::publishDiagnostics(void) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "SafetyAreaManager::publishDiagnostics", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::SafetyAreaManagerDiagnostics diagnostics_msg;

  // copy member variables
  auto uav_state          = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  auto world_origin_units = pairs_lib::get_mutexed(mutex_safety_area_, safety_zone_handler_.parameters.world_origin.units);
  auto origin_x           = pairs_lib::get_mutexed(mutex_safety_area_, safety_zone_handler_.parameters.world_origin.x);
  auto origin_y           = pairs_lib::get_mutexed(mutex_safety_area_, safety_zone_handler_.parameters.world_origin.y);
  ...
  // | -------------- fill in the safety zone data -------------- |
  {
    ...
    pairs_msgs::msg::Point2D tmp_point;
    ...
    for (const auto &[key, obstaclePtr] : obstacles_ptrs) {
      ...
      pairs_msgs::msg::Prism tmp_obstacle;
...
std::tuple<bool, bool> SafetyAreaManager::isPositionValid(pairs_msgs::msg::UavState uav_state) {

  if (!is_initialized_) {
    return std::make_tuple(false, false);
  }

  pairs_msgs::msg::ReferenceStamped current_position;
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::safety_area_manager::SafetyAreaManager)
