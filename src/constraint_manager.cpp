...
class ConstraintManager : public pairs_lib::Node {
...
private:
  ...
  std::map<std::string, std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request>> _constraints_;
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::DynamicsConstraintsSrv> sc_set_constraints_;
  ...
  pairs_lib::Task<bool> setConstraints(std::string constraints_names);

  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String> ss_set_constraints_;

  pairs_lib::Task<bool> callbackSetConstraints(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
  ...
  pairs_lib::Task<>            timerConstraintManagement();
  ...
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ConstraintsOverride> ss_constraints_override_;

  bool callbackConstraintsOverride(const std::shared_ptr<pairs_msgs::srv::ConstraintsOverride::Request>  request,
                                   const std::shared_ptr<pairs_msgs::srv::ConstraintsOverride::Response> response);
  ...
  std::shared_ptr<pairs_msgs::srv::ConstraintsOverride::Request> constraints_override_;

  // | ------------------ diagnostics publisher ----------------- |

  pairs_lib::PublisherHandler<pairs_msgs::msg::ConstraintManagerDiagnostics> ph_diagnostics_;
...
ConstraintManager::ConstraintManager(rclcpp::NodeOptions options) : pairs_lib::Node("control_manager", options) {
...
void ConstraintManager::initialize() {
  ...
  error_publisher_ = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "ConstraintManager", "main");
  ...
  for (it = _constraint_names_.begin(); it != _constraint_names_.end(); ++it) {
    ...
    std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> new_constraints;

    new_constraints = std::make_shared<pairs_msgs::srv::DynamicsConstraintsSrv::Request>();
    ...
    _constraints_.insert(std::pair<std::string, std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request>>(*it, new_constraints));
  }
  ...
  ss_set_constraints_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(node_, "~/set_constraints_in", &ConstraintManager::callbackSetConstraints, this,
                                                                             rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_constraints_override_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ConstraintsOverride>(
  ...
  sc_set_constraints_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::DynamicsConstraintsSrv>(node_, "~/set_constraints_out", cbkgrp_sc_);
  ...
  sh_estimation_diag_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::EstimationDiagnostics>(shopts, "~/estimation_diagnostics_in");

  // | ----------------------- publishers ----------------------- |

  ph_diagnostics_ = pairs_lib::PublisherHandler<pairs_msgs::msg::ConstraintManagerDiagnostics>(node_, "~/diagnostics_out");
  ...
  profiler_ = pairs_lib::Profiler(node_, "ConstraintManager", _profiler_enabled_);
...
pairs_lib::Task<bool> ConstraintManager::setConstraints(std::string constraints_name) {

  std::map<std::string, std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request>>::iterator it;
  ...
  auto request = std::make_shared<pairs_msgs::srv::DynamicsConstraintsSrv::Request>(*it->second);
...
pairs_lib::Task<bool> ConstraintManager::callbackSetConstraints(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
                                                              const std::shared_ptr<pairs_msgs::srv::String::Response> response) {
...
bool ConstraintManager::callbackConstraintsOverride(const std::shared_ptr<pairs_msgs::srv::ConstraintsOverride::Request>  request,
                                                    const std::shared_ptr<pairs_msgs::srv::ConstraintsOverride::Response> response) {
...
pairs_lib::Task<> ConstraintManager::timerConstraintManagement() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerConstraintManagement");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ContraintManager::timerConstraintManagement", scope_timer_logger_, scope_timer_enabled_);
...
void ConstraintManager::timerDiagnostics() {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ContraintManager::timerDiagnostics", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::msg::ConstraintManagerDiagnostics diagnostics;
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::constraint_manager::ConstraintManager)
