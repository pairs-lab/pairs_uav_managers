...
bool validateUavState(const pairs_msgs::UavState& msg, const std::string& node_name, const std::string& var_name) {
...
std::optional<DetailedModelParams_t> loadDetailedUavModelParams(ros::NodeHandle& nh, const std::string& node_name, const std::string& platform_config,
  ...
  pairs_lib::ParamLoader param_loader(nh, node_name);
...
Controller::HwApiOutputVariant initializeDefaultOutput(const ControlOutputModalities_t& possible_outputs, const pairs_msgs::UavState& uav_state,
  ...
  switch (lowest_output) {
    case ACTUATORS_CMD: {
      output = pairs_msgs::HwApiActuatorCmd();
      break;
    }
    case CONTROL_GROUP: {
      output = pairs_msgs::HwApiControlGroupCmd();
      break;
    }
    case ATTITUDE_RATE: {
      output = pairs_msgs::HwApiAttitudeRateCmd();
      break;
    }
    case ATTITUDE: {
      output = pairs_msgs::HwApiAttitudeCmd();
      break;
    }
    case ACCELERATION_HDG_RATE: {
      output = pairs_msgs::HwApiAccelerationHdgRateCmd();
      break;
    }
    case ACCELERATION_HDG: {
      output = pairs_msgs::HwApiAccelerationHdgCmd();
      break;
    }
    case VELOCITY_HDG_RATE: {
      output = pairs_msgs::HwApiVelocityHdgRateCmd();
      break;
    }
    case VELOCITY_HDG: {
      output = pairs_msgs::HwApiVelocityHdgCmd();
      break;
    }
    case POSITION: {
      output = pairs_msgs::HwApiPositionCmd();
      break;
    }
  }

  std::variant<pairs_msgs::UavState> uav_state_var{uav_state};
...
/* initializeHwApiCmd(pairs_msgs::HwApiActuatorCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiControlGroupCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiAttitudeRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiAttitudeCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiAccelerationHdgRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiAccelerationHdgCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiVelocityHdgRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiVelocityHdgCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::HwApiPositionCmd& msg) //{ */
