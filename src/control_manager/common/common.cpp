...
std::optional<DetailedModelParams_t> loadDetailedUavModelParams(const rclcpp::Node::SharedPtr &node, const std::string &platform_config,
  ...
  pairs_lib::ParamLoader param_loader(node);
...
Controller::HwApiOutputVariant initializeDefaultOutput(const rclcpp::Node::SharedPtr &node, const ControlOutputModalities_t &possible_outputs,
  ...
  case ACTUATORS_CMD: {
    output = pairs_msgs::msg::HwApiActuatorCmd();
    break;
  }
  case CONTROL_GROUP: {
    output = pairs_msgs::msg::HwApiControlGroupCmd();
    break;
  }
  case ATTITUDE_RATE: {
    output = pairs_msgs::msg::HwApiAttitudeRateCmd();
    break;
  }
  case ATTITUDE: {
    output = pairs_msgs::msg::HwApiAttitudeCmd();
    break;
  }
  case ACCELERATION_HDG_RATE: {
    output = pairs_msgs::msg::HwApiAccelerationHdgRateCmd();
    break;
  }
  case ACCELERATION_HDG: {
    output = pairs_msgs::msg::HwApiAccelerationHdgCmd();
    break;
  }
  case VELOCITY_HDG_RATE: {
    output = pairs_msgs::msg::HwApiVelocityHdgRateCmd();
    break;
  }
  case VELOCITY_HDG: {
    output = pairs_msgs::msg::HwApiVelocityHdgCmd();
    break;
  }
  case POSITION: {
    output = pairs_msgs::msg::HwApiPositionCmd();
    break;
  }
  }

  std::variant<rclcpp::Node::SharedPtr> node_var{node};
  std::variant<pairs_msgs::msg::UavState> uav_state_var{uav_state};
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiActuatorCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiControlGroupCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiAttitudeRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiAttitudeCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiAccelerationHdgRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiAccelerationHdgCmd& msg) //{ */
...
void initializeHwApiCmd(const rclcpp::Node::SharedPtr &node, pairs_msgs::msg::HwApiAccelerationHdgCmd &msg, const pairs_msgs::msg::UavState &uav_state) {
  ...
  try {
    msg.heading = pairs_lib::AttitudeConverter(uav_state.pose.orientation).getHeading();
  }
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiVelocityHdgRateCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiVelocityHdgCmd& msg) //{ */
...
/* initializeHwApiCmd(pairs_msgs::msg::HwApiPositionCmd& msg) //{ */
