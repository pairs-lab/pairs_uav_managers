...
#include <pairs_uav_managers/control_manager/common.h>
...
#include <pairs_msgs/msg/bool_stamped.hpp>
...
#include <pairs_msgs/msg/control_error.hpp>
...
#include <pairs_msgs/srv/get_float64.hpp>
...
#include <pairs_msgs/msg/reference_array.hpp>
#include <pairs_msgs/msg/trajectory_reference.hpp>

#include <pairs_msgs/srv/reference_stamped_srv.hpp>
#include <pairs_msgs/srv/velocity_reference_stamped_srv.hpp>
#include <pairs_msgs/srv/validate_path_to_point_srv.hpp>
#include <pairs_msgs/srv/get_reference_stamped_srv.hpp>
#include <pairs_msgs/srv/get_bool_srv.hpp>
#include <pairs_msgs/srv/transform_reference_srv.hpp>
#include <pairs_msgs/srv/transform_reference_array_srv.hpp>
...
class ControlManager : public pairs_lib::Node {
...
private:
  ...
  std::unique_ptr<pluginlib::ClassLoader<pairs_uav_managers::Tracker>> tracker_loader_; // pluginlib loader of dynamically loaded trackers
  ...
  std::vector<std::shared_ptr<pairs_uav_managers::Tracker>>            tracker_list_;   // list of trackers, routines are callable from this
  std::mutex                                                         mutex_tracker_list_;

  // | ------------- dynamic loading of controllers ------------- |

  std::unique_ptr<pluginlib::ClassLoader<pairs_uav_managers::Controller>> controller_loader_; // pluginlib loader of dynamically loaded controllers
  ...
  std::vector<std::shared_ptr<pairs_uav_managers::Controller>>            controller_list_;   // list of controllers, routines are callable from this
  ...
  pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry> sh_odometry_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::UavState> sh_uav_state_;

  pairs_msgs::msg::UavState uav_state_;
  pairs_msgs::msg::UavState previous_uav_state_;
  ...
  pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped> sh_max_z_;
  ...
  pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry> sh_odometry_innovation_;
  ...
  pairs_lib::PublisherHandler<pairs_msgs::msg::ControllerDiagnostics>     ph_controller_diagnostics_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::TrackerCommand>            ph_tracker_cmd_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorInput>            ph_pairs_odom_input_;
  pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>                  ph_control_reference_odom_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::ControlManagerDiagnostics> ph_diagnostics_;
  pairs_lib::PublisherHandler<std_msgs::msg::Empty>                     ph_offboard_on_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>            ph_tilt_error_;
  pairs_lib::PublisherHandler<std_msgs::msg::Float64>                   ph_mass_estimate_;
  pairs_lib::PublisherHandler<std_msgs::msg::Float64>                   ph_mass_nominal_;
  pairs_lib::PublisherHandler<std_msgs::msg::Float64>                   ph_throttle_;
  pairs_lib::PublisherHandler<std_msgs::msg::Float64>                   ph_thrust_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::ControlError>              ph_control_error_;
  pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>     ph_disturbances_markers_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::DynamicsConstraints>       ph_current_constraints_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>            ph_heading_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>            ph_speed_;

  // | --------------------- service servers -------------------- |

  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>  ss_switch_tracker_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>  ss_switch_controller_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_reset_tracker_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_hover_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_eland_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_ehover_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_failsafe_;

  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>                ss_failsafe_escalating_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>                ss_toggle_output_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>                ss_arm_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>                ss_enable_callbacks_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::DynamicsConstraintsSrv> ss_set_constraints_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>                ss_use_joystick_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>                ss_use_safety_area_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>    ss_emergency_reference_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>                ss_pirouette_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>                ss_parachute_;

  // human callbable services for references
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4> ss_goto_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4> ss_goto_fcu_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4> ss_goto_relative_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1> ss_goto_altitude_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1> ss_goto_heading_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1> ss_set_heading_relative_;

  // the reference service and subscriber
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv> ss_reference_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::ReferenceStamped>       sh_reference_;

  // the velocity reference service and subscriber
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::VelocityReferenceStampedSrv> ss_velocity_reference_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::VelocityReferenceStamped>       sh_velocity_reference_;

  // trajectory tracking
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::TrajectoryReferenceSrv> ss_trajectory_reference_;
  pairs_lib::SubscriberHandler<pairs_msgs::msg::TrajectoryReference>       sh_trajectory_reference_;

  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_start_trajectory_tracking_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_stop_trajectory_tracking_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_resume_trajectory_tracking_;
  pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger> ss_goto_trajectory_start_;

  // transform service servers
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformReferenceSrv>      ss_transform_reference_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformReferenceArraySrv> ss_transform_reference_array_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformPoseSrv>           ss_transform_pose_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformVector3Srv>        ss_transform_vector3_;

  // safety area services
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReference>      ss_validate_reference_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReference>      ss_validate_reference_2d_;
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReferenceArray> ss_validate_reference_array_;

  // bumper service servers
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool> ss_bumper_enabler_;
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>                sch_shutdown_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>                sch_set_odometry_callbacks_;
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>                sch_parachute_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>    sch_point_in_safety_area_2d_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>    sch_point_in_safety_area_3d_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ValidatePathToPointSrv> sch_path_to_point_in_safety_area_2d_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ValidatePathToPointSrv> sch_path_to_point_in_safety_area_3d_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetReferenceStampedSrv> sch_get_max_z_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetReferenceStampedSrv> sch_get_min_z_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetBoolSrv>             sch_is_safety_area_enabled_;

  // safety area min z servers
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetFloat64> ss_get_min_z_;

  // | --------- trackers' and controllers' last results -------- |

  // the last result of an active tracker
  std::optional<pairs_msgs::msg::TrackerCommand> last_tracker_cmd_;
  ...
  pairs_lib::Task<std::tuple<bool, std::string>> deployParachute(void);
  pairs_lib::Task<bool>                          parachuteSrv(void);

  // safety area routines
  pairs_lib::SubscriberHandler<pairs_msgs::msg::SafetyAreaManagerDiagnostics> sh_safety_area_diag_;

  // those are passed to trackers using the common_handlers object
  pairs_lib::Task<bool>   isPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &point);
  pairs_lib::Task<bool>   isPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &point);
  pairs_lib::Task<bool>   isPathToPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &from, const pairs_msgs::msg::ReferenceStamped &to);
  pairs_lib::Task<bool>   isPathToPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &from, const pairs_msgs::msg::ReferenceStamped &to);
  pairs_lib::Task<double> getMinZ(const std::string &frame_id);
  pairs_lib::Task<double> getMaxZ(const std::string &frame_id);

  // | ------------------------ callbacks ----------------------- |

  // topic callbacks
  pairs_lib::Task<> callbackOdometry(const nav_msgs::msg::Odometry::ConstSharedPtr msg);
  pairs_lib::Task<> callbackUavState(const pairs_msgs::msg::UavState::ConstSharedPtr msg);
  ...
  pairs_lib::Task<> callbackRC(const pairs_msgs::msg::HwApiRcChannels::ConstSharedPtr msg);

  // topic timeouts
  pairs_lib::Task<> timeoutUavState(const double &missing_for);

  // switching controller and tracker services
  bool callbackSwitchTracker(const std::shared_ptr<pairs_msgs::srv::String::Request> request, const std::shared_ptr<pairs_msgs::srv::String::Response> response);
  bool callbackSwitchController(const std::shared_ptr<pairs_msgs::srv::String::Request> request, const std::shared_ptr<pairs_msgs::srv::String::Response> response);
  bool callbackTrackerResetStatic(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                  const std::shared_ptr<std_srvs::srv::Trigger::Response> response);

  // reference callbacks
  pairs_lib::Task<> callbackReferenceTopic(const pairs_msgs::msg::ReferenceStamped::ConstSharedPtr msg);
  pairs_lib::Task<> callbackVelocityReferenceTopic(const pairs_msgs::msg::VelocityReferenceStamped::ConstSharedPtr msg);
  pairs_lib::Task<> callbackTrajectoryReferenceTopic(const pairs_msgs::msg::TrajectoryReference::ConstSharedPtr msg);

  pairs_lib::Task<bool> callbackGoto(const std::shared_ptr<pairs_msgs::srv::Vec4::Request> request, const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response);
  pairs_lib::Task<bool> callbackGotoFcu(const std::shared_ptr<pairs_msgs::srv::Vec4::Request>  request,
                                      const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response);
  pairs_lib::Task<bool> callbackGotoRelative(const std::shared_ptr<pairs_msgs::srv::Vec4::Request>  request,
                                           const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response);
  pairs_lib::Task<bool> callbackGotoAltitude(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                           const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response);
  pairs_lib::Task<bool> callbackSetHeading(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                         const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response);
  pairs_lib::Task<bool> callbackSetHeadingRelative(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                                 const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response);
  pairs_lib::Task<bool> callbackReferenceService(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                               const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  pairs_lib::Task<bool> callbackVelocityReferenceService(const std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Request>  request,
                                                       const std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Response> response);
  pairs_lib::Task<bool> callbackTrajectoryReferenceService(const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request>  request,
                                                         const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Response> response);
  pairs_lib::Task<bool> callbackEmergencyReference(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                 const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);
  ...
  bool callbackGotoTrajectoryStart(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                   const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackEHover(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                     const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackFailsafe(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                       const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackFailsafeEscalating(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                                 const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackEland(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                    const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  pairs_lib::Task<bool> callbackParachute(const std::shared_ptr<std_srvs::srv::Trigger::Request>  request,
                                        const std::shared_ptr<std_srvs::srv::Trigger::Response> response);
  ...
  pairs_lib::Task<bool> callbackArm(const std::shared_ptr<std_srvs::srv::SetBool::Request>  request,
  ...
  pairs_lib::Task<bool> callbackGetMinZ(const std::shared_ptr<pairs_msgs::srv::GetFloat64::Request>  request,
                                      const std::shared_ptr<pairs_msgs::srv::GetFloat64::Response> response);

  pairs_lib::Task<bool> callbackValidateReference(const std::shared_ptr<pairs_msgs::srv::ValidateReference::Request>  request,
                                                const std::shared_ptr<pairs_msgs::srv::ValidateReference::Response> response);
  pairs_lib::Task<bool> callbackValidateReference2d(const std::shared_ptr<pairs_msgs::srv::ValidateReference::Request>  request,
                                                  const std::shared_ptr<pairs_msgs::srv::ValidateReference::Response> response);
  pairs_lib::Task<bool> callbackValidateReferenceArray(const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Request>  request,
                                                     const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Response> response);

  // transformation callbacks
  bool callbackTransformReference(const std::shared_ptr<pairs_msgs::srv::TransformReferenceSrv::Request>  request,
                                  const std::shared_ptr<pairs_msgs::srv::TransformReferenceSrv::Response> response);
  bool callbackTransformReferenceArray(const std::shared_ptr<pairs_msgs::srv::TransformReferenceArraySrv::Request>  request,
                                       const std::shared_ptr<pairs_msgs::srv::TransformReferenceArraySrv::Response> response);
  bool callbackTransformPose(const std::shared_ptr<pairs_msgs::srv::TransformPoseSrv::Request>  request,
                             const std::shared_ptr<pairs_msgs::srv::TransformPoseSrv::Response> response);
  bool callbackTransformVector3(const std::shared_ptr<pairs_msgs::srv::TransformVector3Srv::Request>  request,
                                const std::shared_ptr<pairs_msgs::srv::TransformVector3Srv::Response> response);

  // | ----------------------- constraints ---------------------- |

  // sets constraints to all trackers
  bool callbackSetConstraints(const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request>  request,
                              const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response> response);

  // constraints management
  bool              got_constraints_ = false;
  std::mutex        mutex_constraints_;
  void              setConstraints(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints);
  void              setConstraintsToTrackers(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints);
  void              setConstraintsToControllers(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints);
  std::atomic<bool> constraints_being_enforced_ = false;

  std::optional<pairs_msgs::srv::DynamicsConstraintsSrv::Request>
  enforceControllersConstraints(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints);

  pairs_msgs::srv::DynamicsConstraintsSrv::Request current_constraints_;
  pairs_msgs::srv::DynamicsConstraintsSrv::Request sanitized_constraints_;
  ...
  pairs_lib::Task<>            timerFailsafe();

  // oneshot timer for running controllers and trackers
  pairs_lib::Task<>   asyncControl(void);
  ...
  // bumper subscriber
  pairs_lib::SubscriberHandler<pairs_msgs::msg::ObstacleSectors> sh_bumper_;
  ...
  pairs_lib::Task<>                                       ungripSrv(void);
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger> sch_ungrip_;
  ...
  pairs_lib::SubscriberHandler<sensor_msgs::msg::Joy> sh_joystick_;
  ...
  pairs_lib::SubscriberHandler<pairs_msgs::msg::HwApiRcChannels> sh_hw_api_rc_;
  ...
  pairs_lib::PublisherHandler<geometry_msgs::msg::PoseArray>        pub_debug_original_trajectory_poses_;
  pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_debug_original_trajectory_markers_;

  // | --------------------- other routines --------------------- |

  // this is called to update the trackers and to receive position control command from the active one
  pairs_lib::Task<> updateTrackers(void);

  // this is called to update the controllers and to receive attitude control command from the active one
  pairs_lib::Task<> updateControllers(const pairs_msgs::msg::UavState &uav_state);

  // sets the reference to the active tracker
  pairs_lib::Task<std::tuple<bool, std::string>> setReference(const pairs_msgs::msg::ReferenceStamped reference_in);

  // sets the velocity reference to the active tracker
  pairs_lib::Task<std::tuple<bool, std::string>> setVelocityReference(const pairs_msgs::msg::VelocityReferenceStamped &reference_in);

  // sets the reference trajectory to the active tracker
  pairs_lib::Task<std::tuple<bool, std::string, bool, std::vector<std::string>, std::vector<bool>, std::vector<std::string>>>
  setTrajectoryReference(const pairs_msgs::msg::TrajectoryReference trajectory_in);
  ...
  void publishControlReferenceOdom(const std::optional<pairs_msgs::msg::TrackerCommand> &tracker_command, const Controller::ControlOutput &control_output);

  void initializeControlOutput(void);

  // tell the pairs_odometry to disable its callbacks
  pairs_lib::Task<> odometryCallbacksSrv(const bool input);

  pairs_msgs::msg::ReferenceStamped velocityReferenceToReference(const pairs_msgs::msg::VelocityReferenceStamped &vel_reference);

  void                                         setCallbacks(bool in);
  bool                                         isOffboard(void);
  pairs_lib::Task<bool>                          elandSrv(void);
  pairs_lib::Task<std::tuple<bool, std::string>> arming(const bool input);

  // safety functions impl
  pairs_lib::Task<std::tuple<bool, std::string>> ehover(void);
  ...
  pairs_lib::Task<std::tuple<bool, std::string>> escalatingFailsafe(void);
  pairs_lib::Task<std::tuple<bool, std::string>> failsafe(void);
  pairs_lib::Task<std::tuple<bool, std::string>> eland(void);
...
ControlManager::ControlManager(rclcpp::NodeOptions options) : pairs_lib::Node("control_manager", options) {

  node_  = this_node_ptr();
  clock_ = node_->get_clock();

  error_publisher_ = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "ControlManager", "main");
  ...
  sh_hw_api_capabilities_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::HwApiCapabilities>(shopts, "~/hw_api_capabilities_in");
...
void ControlManager::initialize(void) {
  ...
  common_handlers_ = std::make_shared<pairs_uav_managers::control_manager::CommonHandlers_t>();
  ...
  param_loader_->setPrefix("pairs_uav_managers/control_manager/");
  ...
  param_loader_->loadParam("pairs_trackers", _tracker_names_);
  ...
  tracker_loader_ = std::make_unique<pluginlib::ClassLoader<pairs_uav_managers::Tracker>>("pairs_uav_managers", "pairs_uav_managers::Tracker");
  ...
  trackers_subnode_ = node_->create_sub_node("pairs_uav_trackers");
  ...
  for (int i = 0; i < int(tracker_list_.size()); i++) {
    ...
    std::shared_ptr<pairs_uav_managers::control_manager::PrivateHandlers_t> private_handlers =
        std::make_shared<pairs_uav_managers::control_manager::PrivateHandlers_t>();

    private_handlers->name_space   = it->second.name_space;
    private_handlers->runtime_name = _tracker_names_.at(i);
    private_handlers->param_loader = std::make_unique<pairs_lib::ParamLoader>(subnode, _tracker_names_.at(i));
  ...
  param_loader_->setPrefix("pairs_uav_managers/control_manager/");
  param_loader_->loadParam("pairs_controllers", _controller_names_);
  ...
  controller_loader_ = std::make_unique<pluginlib::ClassLoader<pairs_uav_managers::Controller>>("pairs_uav_managers", "pairs_uav_managers::Controller");
  ...
  controllers_subnode_ = node_->create_sub_node("pairs_uav_controllers");
  param_loader_->setPrefix("");
  ...
  for (int i = 0; i < int(controller_list_.size()); i++) {
    ...
    private_handlers->param_loader = std::make_unique<pairs_lib::ParamLoader>(subnode, _controller_names_.at(i));
    private_handlers->param_loader->copyYamls(*param_loader_);
    private_handlers->parent_param_loader = param_loader_;
  ...
  profiler_ = pairs_lib::Profiler(node_, "ControlManager", _profiler_enabled_);

  // | ----------------------- publishers ----------------------- |

  control_output_publisher_ = OutputPublisher(node_);

  ph_controller_diagnostics_ = pairs_lib::PublisherHandler<pairs_msgs::msg::ControllerDiagnostics>(node_, "~/controller_diagnostics_out");
  ph_tracker_cmd_            = pairs_lib::PublisherHandler<pairs_msgs::msg::TrackerCommand>(node_, "~/tracker_cmd_out");
  ph_pairs_odom_input_         = pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorInput>(node_, "~/estimator_input_out");
  ph_control_reference_odom_ = pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>(node_, "~/control_reference_out");
  ph_diagnostics_            = pairs_lib::PublisherHandler<pairs_msgs::msg::ControlManagerDiagnostics>(node_, "~/diagnostics_out");
  ph_offboard_on_            = pairs_lib::PublisherHandler<std_msgs::msg::Empty>(node_, "~/offboard_on_out");
  ph_tilt_error_             = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/tilt_error_out");
  ph_mass_nominal_           = pairs_lib::PublisherHandler<std_msgs::msg::Float64>(node_, "~/mass_nominal_out"); // TODO latch
  ph_control_error_          = pairs_lib::PublisherHandler<pairs_msgs::msg::ControlError>(node_, "~/control_error_out");

  {
    ...
    ph_throttle_ = pairs_lib::PublisherHandler<std_msgs::msg::Float64>(opts, "~/throttle_out");
  }

  {
    ...
    ph_thrust_ = pairs_lib::PublisherHandler<std_msgs::msg::Float64>(opts, "~/thrust_out");
  }

  {
    ...
    ph_mass_estimate_ = pairs_lib::PublisherHandler<std_msgs::msg::Float64>(opts, "~/mass_estimate_out");
  }

  {
    ...
    ph_disturbances_markers_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(opts, "~/disturbances_markers_out");
  }

  ph_current_constraints_ = pairs_lib::PublisherHandler<pairs_msgs::msg::DynamicsConstraints>(node_, "~/current_constraints_out");
  ph_heading_             = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/heading_out");
  ph_speed_               = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/speed_out");

  {
    ...
    pub_debug_original_trajectory_poses_   = pairs_lib::PublisherHandler<geometry_msgs::msg::PoseArray>(opts, "~/trajectory_original/poses_out");
    pub_debug_original_trajectory_markers_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(opts, "~/trajectory_original/markers_out");
  }
  ...
  if (_hover_throttle_range_check_enabled_) {
    ...
    double hover_throttle = pairs_lib::quadratic_throttle_model::forceToThrottle(common_handlers_->throttle_model, _uav_mass_ * common_handlers_->g, *node_);
  ...
  if (_state_input_ == INPUT_UAV_STATE) {
    sh_uav_state_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::UavState>(shopts_co, "~/uav_state_in", &ControlManager::callbackUavState, this);
  } else if (_state_input_ == INPUT_ODOMETRY) {
    sh_odometry_ = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts_co, "~/odometry_in", &ControlManager::callbackOdometry, this);
  }

  if (_odometry_innovation_check_enabled_) {
    sh_odometry_innovation_ = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, "~/odometry_innovation_in");
  }

  sh_bumper_           = pairs_lib::SubscriberHandler<pairs_msgs::msg::ObstacleSectors>(shopts, "~/bumper_sectors_in");
  sh_max_z_            = pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped>(shopts, "~/max_z_in");
  sh_safety_area_diag_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::SafetyAreaManagerDiagnostics>(shopts, "~/safety_area_diag_in");
  sh_joystick_         = pairs_lib::SubscriberHandler<sensor_msgs::msg::Joy>(shopts, "~/joystick_in", &ControlManager::callbackJoystick, this);
  sh_gnss_             = pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(shopts, "~/gnss_in", &ControlManager::callbackGNSS, this);
  sh_hw_api_rc_        = pairs_lib::SubscriberHandler<pairs_msgs::msg::HwApiRcChannels>(shopts_co, "~/hw_api_rc_in", &ControlManager::callbackRC, this);

  sh_hw_api_status_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::HwApiStatus>(shopts, "~/hw_api_status_in", &ControlManager::callbackHwApiStatus, this);

  // | -------------------- general services -------------------- |

  ss_switch_tracker_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(
  ...
  ss_switch_controller_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(
      node_, "~/switch_controller_in", std::bind(&ControlManager::callbackSwitchController, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_reset_tracker_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      ...
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_hover_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      ...
      cbkgrp_ss_);
  ss_ehover_   = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/ehover_in", &ControlManager::callbackEHover, this, rclcpp::SystemDefaultsQoS(),
                                                                       cbkgrp_ss_);
  ss_failsafe_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/failsafe_in", &ControlManager::callbackFailsafe, this,
                                                                       rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_failsafe_escalating_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      node_, "~/failsafe_escalating_in", &ControlManager::callbackFailsafeEscalating, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_toggle_output_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
      node_, "~/toggle_output_in", std::bind(&ControlManager::callbackToggleOutput, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_arm_ =
      pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(node_, "~/arm_in", &ControlManager::callbackArm, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_enable_callbacks_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
      node_, "~/enable_callbacks_in", std::bind(&ControlManager::callbackEnableCallbacks, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_set_constraints_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::DynamicsConstraintsSrv>(
      node_, "~/set_constraints_in", std::bind(&ControlManager::callbackSetConstraints, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_use_joystick_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      node_, "~/use_joystick_in", std::bind(&ControlManager::callbackUseJoystick, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_eland_ =
      pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/eland_in", &ControlManager::callbackEland, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_parachute_           = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(node_, "~/parachute_in", &ControlManager::callbackParachute, this,
                                                                                  rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_transform_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformReferenceSrv>(
      ...
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_transform_reference_array_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformReferenceArraySrv>(
      ...
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_transform_pose_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformPoseSrv>(
      node_, "~/transform_pose_in", std::bind(&ControlManager::callbackTransformPose, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_transform_vector3_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::TransformVector3Srv>(
      node_, "~/transform_vector3_in", std::bind(&ControlManager::callbackTransformVector3, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_bumper_enabler_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
      ...
      cbkgrp_ss_);
  ss_get_min_z_          = pairs_lib::ServiceServerHandler<pairs_msgs::srv::GetFloat64>(node_, "~/get_min_z_in", &ControlManager::callbackGetMinZ, this,
                                                                                    rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_validate_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReference>(
      node_, "~/validate_reference_in", &ControlManager::callbackValidateReference, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_validate_reference_2d_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReference>(
      node_, "~/validate_reference_2d_in", &ControlManager::callbackValidateReference2d, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_validate_reference_array_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ValidateReferenceArray>(
      node_, "~/validate_reference_array_in", &ControlManager::callbackValidateReferenceArray, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_start_trajectory_tracking_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      ...
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_stop_trajectory_tracking_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      ...
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_resume_trajectory_tracking_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
      ...
      cbkgrp_ss_);
  ss_goto_trajectory_start_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
  ...
  sch_arming_                  = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/hw_api_arming_out", cbkgrp_sc_);
  sch_eland_                   = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/eland_out", cbkgrp_sc_);
  sch_shutdown_                = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/shutdown_out", cbkgrp_sc_);
  sch_set_odometry_callbacks_  = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "~/set_odometry_callbacks_out", cbkgrp_sc_);
  sch_ungrip_                  = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/ungrip_out", cbkgrp_sc_);
  sch_parachute_               = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/parachute_out", cbkgrp_sc_);
  sch_point_in_safety_area_2d_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/point_in_safety_area_2d_out", cbkgrp_sc_);
  sch_point_in_safety_area_3d_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/point_in_safety_area_3d_out", cbkgrp_sc_);
  sch_path_to_point_in_safety_area_2d_ =
      pairs_lib::ServiceClientHandler<pairs_msgs::srv::ValidatePathToPointSrv>(node_, "~/path_in_safety_area_2d_out", cbkgrp_sc_);
  sch_path_to_point_in_safety_area_3d_ =
      pairs_lib::ServiceClientHandler<pairs_msgs::srv::ValidatePathToPointSrv>(node_, "~/path_in_safety_area_3d_out", cbkgrp_sc_);
  sch_get_min_z_              = pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetReferenceStampedSrv>(node_, "~/get_min_z_out", cbkgrp_sc_);
  sch_get_max_z_              = pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetReferenceStampedSrv>(node_, "~/get_max_z_out", cbkgrp_sc_);
  sch_is_safety_area_enabled_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::GetBoolSrv>(node_, "~/is_safety_area_enabled_out", cbkgrp_sc_);

  // | ---------------- setpoint command services --------------- |

  // human callable
  ss_goto_ =
      pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4>(node_, "~/goto_in", &ControlManager::callbackGoto, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_goto_fcu_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4>(node_, "~/goto_fcu_in", &ControlManager::callbackGotoFcu, this, rclcpp::SystemDefaultsQoS(),
                                                                    cbkgrp_ss_);
  ss_goto_relative_        = pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec4>(node_, "~/goto_relative_in", &ControlManager::callbackGotoRelative, this,
                                                                                rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_goto_altitude_        = pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1>(node_, "~/goto_altitude_in", &ControlManager::callbackGotoAltitude, this,
                                                                                rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_goto_heading_         = pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1>(node_, "~/set_heading_in", &ControlManager::callbackSetHeading, this,
                                                                                rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_set_heading_relative_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::Vec1>(node_, "~/set_heading_relative_in", &ControlManager::callbackSetHeadingRelative,
                                                                                this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/reference_in", &ControlManager::callbackReferenceService, this,
                                                                                    rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  sh_reference_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::ReferenceStamped>(shopts_co, "~/reference_in", &ControlManager::callbackReferenceTopic, this);

  ss_velocity_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::VelocityReferenceStampedSrv>(
      node_, "~/velocity_reference_in", &ControlManager::callbackVelocityReferenceService, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  sh_velocity_reference_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::VelocityReferenceStamped>(shopts_co, "~/velocity_reference_in",
                                                                                               &ControlManager::callbackVelocityReferenceTopic, this);

  ss_trajectory_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::TrajectoryReferenceSrv>(
      node_, "~/trajectory_reference_in", &ControlManager::callbackTrajectoryReferenceService, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  sh_trajectory_reference_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::TrajectoryReference>(shopts_co, "~/trajectory_reference_in",
                                                                                            &ControlManager::callbackTrajectoryReferenceTopic, this);

  // | --------------------- other services --------------------- |

  ss_emergency_reference_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
      node_, "~/emergency_reference_in", &ControlManager::callbackEmergencyReference, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ss_pirouette_ = pairs_lib::ServiceServerHandler<std_srvs::srv::Trigger>(
  ...
  pairs_lib::TimerHandlerOptions timer_opts_co_start;
  ...
  pairs_lib::TimerHandlerOptions timer_opts_co_no_start;
...
void ControlManager::timerHwApiCapabilities() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerHwApiCapabilities");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerHwApiCapabilities", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::timerStatus() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerStatus");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerStatus", scope_timer_logger_, scope_timer_enabled_);
  ...
  auto yaw_error             = pairs_lib::get_mutexed(mutex_attitude_error_, yaw_error_);
  auto position_error        = pairs_lib::get_mutexed(mutex_position_error_, position_error_);
  auto active_controller_idx = pairs_lib::get_mutexed(mutex_controller_list_, active_controller_idx_);
  auto active_tracker_idx    = pairs_lib::get_mutexed(mutex_tracker_list_, active_tracker_idx_);
  ...
  // --------------------------------------------------------------
  {
    ...
    if (tilt_error_) {
      ...
      pairs_msgs::msg::Float64Stamped tilt_error_out;
  ...
  if (position_error) {
    ...
    pairs_msgs::msg::ControlError msg_out;
  ...
  if (_state_input_ == INPUT_UAV_STATE && sh_uav_state_.hasMsg()) {
    ...
    try {
      ...
      pairs_msgs::msg::Float64Stamped heading_out;
  ...
  if (_state_input_ == INPUT_UAV_STATE && sh_uav_state_.hasMsg()) {
    ...
    pairs_msgs::msg::Float64Stamped speed_out;
  ...
  if (last_control_output.diagnostics.disturbance_estimator && got_uav_state_) {
    ...
    Eigen::Quaterniond quat_eigen = pairs_lib::AttitudeConverter(uav_state.pose.orientation);
  ...
  if (got_constraints_) {
    ...
    auto sanitized_constraints = pairs_lib::get_mutexed(mutex_constraints_, sanitized_constraints_);

    pairs_msgs::msg::DynamicsConstraints constraints = sanitized_constraints.constraints;
...
pairs_lib::Task<> ControlManager::timerSafety() {

  pairs_lib::AtomicScopeFlag unset_running(running_safety_timer_);

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerSafety");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerSafety", scope_timer_logger_, scope_timer_enabled_);

  // copy member variables
  auto last_control_output   = pairs_lib::get_mutexed(mutex_last_control_output_, last_control_output_);
  auto last_tracker_cmd      = pairs_lib::get_mutexed(mutex_last_tracker_cmd_, last_tracker_cmd_);
  auto [uav_state, uav_yaw]  = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_, uav_yaw_);
  auto active_controller_idx = pairs_lib::get_mutexed(mutex_controller_list_, active_controller_idx_);
  auto active_tracker_idx    = pairs_lib::get_mutexed(mutex_tracker_list_, active_tracker_idx_);
...

  {
    ...
    if (last_tracker_cmd->use_position_horizontal && !std::holds_alternative<pairs_msgs::msg::HwApiPositionCmd>(last_control_output.control_output.value())) {
    ...
    if (last_tracker_cmd->use_position_vertical && !std::holds_alternative<pairs_msgs::msg::HwApiPositionCmd>(last_control_output.control_output.value())) {
    ...
    if (position_error_set) {
      ...
      pairs_lib::set_mutexed(mutex_position_error_, {position_error}, position_error_);
    }
  }
  ...
  if (last_control_output.desired_orientation) {
    ...
    tf2::Transform attitude_cmd_transform = pairs_lib::AttitudeConverter(last_control_output.desired_orientation.value());
...

    {
      ...
      double cmd_yaw = pairs_lib::AttitudeConverter(last_control_output.desired_orientation.value()).getYaw();
      yaw_error_     = fabs(radians::diff(cmd_yaw, uav_yaw));
    }
  }

  auto position_error          = pairs_lib::get_mutexed(mutex_position_error_, position_error_);
  auto [tilt_error, yaw_error] = pairs_lib::get_mutexed(mutex_attitude_error_, tilt_error_, yaw_error_);
  ...
  if (position_error) {
    ...
    if (position_error->norm() > _failsafe_threshold_ && !failsafe_triggered_) {
      ...
      auto controller_tracker_switch_time = pairs_lib::get_mutexed(mutex_controller_tracker_switch_time_, controller_tracker_switch_time_);
  ...
  if (_odometry_innovation_check_enabled_) {
    ...
    if (innovation) {
      ...
      auto [x, y, z] = pairs_lib::getPosition(innovation.value());

      double heading = 0;
      try {
        heading = pairs_lib::getHeading(innovation.value());
      }
      ...
      double last_innovation = pairs_lib::geometry::dist(vec3_t(x, y, z), vec3_t(0, 0, 0));
...
pairs_lib::Task<> ControlManager::timerEland() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerEland");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerEland", scope_timer_logger_, scope_timer_enabled_);
  ...
  if (current_state_landing_ == IDLE_STATE) {
    ...
    throttle_mass_estimate_ = pairs_lib::quadratic_throttle_model::throttleToForce(common_handlers_->throttle_model, throttle.value()) / common_handlers_->g;
...
pairs_lib::Task<> ControlManager::timerFailsafe() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerFailsafe");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerFailsafe", scope_timer_logger_, scope_timer_enabled_);
  ...
  double throttle_mass_estimate_ = pairs_lib::quadratic_throttle_model::throttleToForce(common_handlers_->throttle_model, throttle.value()) / common_handlers_->g;
...
pairs_lib::Task<> ControlManager::timerJoystick() {

  pairs_lib::AtomicScopeFlag unset_running(running_timer_joystick_);

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerJoystick");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerJoystick", scope_timer_logger_, scope_timer_enabled_);
  ...
  if (joystick_goto_enabled_ && sh_joystick_.hasMsg()) {
    ...
    if (fabs(joystick_data->axes.at(_channel_pitch_)) >= 0.05 || fabs(joystick_data->axes.at(_channel_roll_)) >= 0.05 ||
      ...
      if (_joystick_mode_ == 0) {
        ...
        std::shared_ptr<pairs_msgs::srv::Vec4::Response> response = std::make_shared<pairs_msgs::srv::Vec4::Response>();
  ...
  if (rc_goto_active_ && !bumper_repulsing_ && last_tracker_cmd && sh_hw_api_rc_.hasMsg()) {
    ...
    // create the reference
    std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Request> request = std::make_shared<pairs_msgs::srv::VelocityReferenceStampedSrv::Request>();
    ...
    // copy member variables
    pairs_msgs::msg::HwApiRcChannels::ConstSharedPtr rc_channels = sh_hw_api_rc_.getMsg();
    ...
    if (!nothing_to_do) {
      ...
      std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Response> response = std::make_shared<pairs_msgs::srv::VelocityReferenceStampedSrv::Response>();
...
void ControlManager::timerBumper() {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerBumper");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerBumper", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<> ControlManager::timerPirouette() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerPirouette");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::timerPirouette", scope_timer_logger_, scope_timer_enabled_);
  ...
  // set the reference
  pairs_msgs::msg::ReferenceStamped reference_request;
...
pairs_lib::Task<> ControlManager::asyncControl(void) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::AtomicScopeFlag unset_running(running_async_control_);

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("asyncControl");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::asyncControl", scope_timer_logger_, scope_timer_enabled_);

  // copy member variables
  auto uav_state           = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  auto current_constraints = pairs_lib::get_mutexed(mutex_constraints_, current_constraints_);
  ...
  if (!failsafe_triggered_) { // when failsafe is triggered, updateControllers() and publish() is called in timerFailsafe()
    ...
    if (got_constraints_) {
      ...
      if (enforce && !constraints_being_enforced_) {
        ...
        pairs_lib::set_mutexed(mutex_constraints_, enforce.value(), sanitized_constraints_);
        ...
        pairs_lib::set_mutexed(mutex_constraints_, current_constraints, sanitized_constraints_);
...
pairs_lib::Task<> ControlManager::callbackOdometry(const nav_msgs::msg::Odometry::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackOdometry");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackOdometry", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::msg::UavState uav_state_odom;
...

  {
    ...
    uav_state_ = pairs_msgs::msg::UavState();
    ...
    std::tie(uav_roll_, uav_pitch_, uav_yaw_) = pairs_lib::AttitudeConverter(msg->pose.pose.orientation);

    try {
      uav_heading_ = pairs_lib::AttitudeConverter(msg->pose.pose.orientation).getHeading();
    }
    catch (...) {
...
pairs_lib::Task<> ControlManager::callbackUavState(const pairs_msgs::msg::UavState::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackUavState");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackUavState", scope_timer_logger_, scope_timer_enabled_);
...

  {
    ...
    std::tie(uav_roll_, uav_pitch_, uav_yaw_) = pairs_lib::AttitudeConverter(uav_state_.pose.orientation);

    try {
      uav_heading_ = pairs_lib::AttitudeConverter(uav_state_.pose.orientation).getHeading();
    }
    catch (...) {
...
void ControlManager::callbackGNSS(const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackGNSS");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackGNSS", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackJoystick(const sensor_msgs::msg::Joy::ConstSharedPtr msg) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackJoystick");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackJoystick", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackHwApiStatus(const pairs_msgs::msg::HwApiStatus::ConstSharedPtr msg) {

  if (!is_initialized_) {
    return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackHwApiStatus");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackHwApiStatus", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::HwApiStatus::ConstSharedPtr state = msg;
...
pairs_lib::Task<> ControlManager::callbackRC(const pairs_msgs::msg::HwApiRcChannels::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackRC");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackRC", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::HwApiRcChannels::ConstSharedPtr rc = msg;
...
pairs_lib::Task<> ControlManager::timeoutUavState(const double &missing_for) {
...
bool ControlManager::callbackSwitchTracker(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
                                           const std::shared_ptr<pairs_msgs::srv::String::Response> response) {
...
bool ControlManager::callbackSwitchController(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
                                              const std::shared_ptr<pairs_msgs::srv::String::Response> response) {
...
pairs_lib::Task<bool> ControlManager::callbackEHover([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                   const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackFailsafe([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                     const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackFailsafeEscalating([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                               const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackEland([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                  const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackParachute([[maybe_unused]] const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
                                                      const std::shared_ptr<std_srvs::srv::Trigger::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackArm(const std::shared_ptr<std_srvs::srv::SetBool::Request>  request,
                                                const std::shared_ptr<std_srvs::srv::SetBool::Response> response) {
...
bool ControlManager::callbackSetConstraints(const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request>  request,
                                            const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response> response) {
...
pairs_lib::Task<bool> ControlManager::callbackEmergencyReference(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                               const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
  ...
  std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Response> tracker_response = std::make_shared<pairs_msgs::srv::ReferenceSrv::Response>();

  std::stringstream ss;

  // transform the reference to the current frame
  pairs_msgs::msg::ReferenceStamped original_reference;
  ...
  pairs_msgs::msg::ReferenceStamped transformed_reference = ret.value();

  std::shared_ptr<std_srvs::srv::SetBool::Request> req_enable_callbacks = std::make_shared<std_srvs::srv::SetBool::Request>();

  std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Request> req_goto_out = std::make_shared<pairs_msgs::srv::ReferenceSrv::Request>();
...
bool ControlManager::callbackTransformReference(const std::shared_ptr<pairs_msgs::srv::TransformReferenceSrv::Request>  request,
                                                const std::shared_ptr<pairs_msgs::srv::TransformReferenceSrv::Response> response) {
  ...
  // transform the reference to the current frame
  pairs_msgs::msg::ReferenceStamped transformed_reference = request->reference;
...
bool ControlManager::callbackTransformReferenceArray(const std::shared_ptr<pairs_msgs::srv::TransformReferenceArraySrv::Request>  request,
                                                     const std::shared_ptr<pairs_msgs::srv::TransformReferenceArraySrv::Response> response) {
...
bool ControlManager::callbackTransformPose(const std::shared_ptr<pairs_msgs::srv::TransformPoseSrv::Request>  request,
                                           const std::shared_ptr<pairs_msgs::srv::TransformPoseSrv::Response> response) {
...
bool ControlManager::callbackTransformVector3(const std::shared_ptr<pairs_msgs::srv::TransformVector3Srv::Request>  request,
                                              const std::shared_ptr<pairs_msgs::srv::TransformVector3Srv::Response> response) {
...
pairs_lib::Task<bool> ControlManager::callbackGetMinZ([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::GetFloat64::Request> request,
                                                    const std::shared_ptr<pairs_msgs::srv::GetFloat64::Response>                 response) {
...
pairs_lib::Task<bool> ControlManager::callbackValidateReference(const std::shared_ptr<pairs_msgs::srv::ValidateReference::Request>  request,
                                                              const std::shared_ptr<pairs_msgs::srv::ValidateReference::Response> response) {
  ...
  if (last_tracker_cmd) {
    ...
    pairs_msgs::msg::ReferenceStamped from_point;
...
pairs_lib::Task<bool> ControlManager::callbackValidateReference2d(const std::shared_ptr<pairs_msgs::srv::ValidateReference::Request>  request,
                                                                const std::shared_ptr<pairs_msgs::srv::ValidateReference::Response> response) {
...
pairs_lib::Task<bool> ControlManager::callbackValidateReferenceArray(const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Request>  request,
                                                                   const std::shared_ptr<pairs_msgs::srv::ValidateReferenceArray::Response> response) {
...
pairs_lib::Task<bool> ControlManager::callbackReferenceService(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                             const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackReferenceService");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackReferenceService", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::ReferenceStamped des_reference;
...
pairs_lib::Task<> ControlManager::callbackReferenceTopic(const pairs_msgs::msg::ReferenceStamped::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackReferenceTopic");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackVelocityReferenceService(const std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Request>  request,
                                                                     const std::shared_ptr<pairs_msgs::srv::VelocityReferenceStampedSrv::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackVelocityReferenceService");
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "ControlManager::callbackVelocityReferenceService", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::VelocityReferenceStamped des_reference;
...
pairs_lib::Task<> ControlManager::callbackVelocityReferenceTopic(const pairs_msgs::msg::VelocityReferenceStamped::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackVelocityReferenceTopic");
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "ControlManager::callbackVelocityReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackTrajectoryReferenceService(const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request>  request,
                                                                       const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackTrajectoryReferenceService");
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "ControlManager::callbackTrajectoryReferenceService", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<> ControlManager::callbackTrajectoryReferenceTopic(const pairs_msgs::msg::TrajectoryReference::ConstSharedPtr msg) {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackTrajectoryReferenceTopic");
  pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "ControlManager::callbackTrajectoryReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackGoto(const std::shared_ptr<pairs_msgs::srv::Vec4::Request>  request,
                                                 const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackGoto");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackGoto", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackGotoFcu(const std::shared_ptr<pairs_msgs::srv::Vec4::Request>  request,
                                                    const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackGotoFcu");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackGotoFcu", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackGotoRelative(const std::shared_ptr<pairs_msgs::srv::Vec4::Request>  request,
                                                         const std::shared_ptr<pairs_msgs::srv::Vec4::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackGotoRelative");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackGotoRelative", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackGotoAltitude(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                                         const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackGotoAltitude");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackGotoAltitude", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackSetHeading(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                                       const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackSetHeading");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackSetHeading", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<bool> ControlManager::callbackSetHeadingRelative(const std::shared_ptr<pairs_msgs::srv::Vec1::Request>  request,
                                                               const std::shared_ptr<pairs_msgs::srv::Vec1::Response> response) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("callbackSetHeadingRelative");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::callbackSetHeadingRelative", scope_timer_logger_, scope_timer_enabled_);
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::setReference(const pairs_msgs::msg::ReferenceStamped reference_in) {
  ...
  std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Request> reference_request = std::make_shared<pairs_msgs::srv::ReferenceSrv::Request>();
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::setVelocityReference(const pairs_msgs::msg::VelocityReferenceStamped &reference_in) {
  ...
  pairs_msgs::msg::VelocityReferenceStamped transformed_reference = reference_in;
  ...
  // transform the z and the heading
  {
    ...
    pose.pose.orientation = pairs_lib::AttitudeConverter(0, 0, reference_in.reference.heading);
    ...
    if (!ret) {
      ...
      transformed_reference.reference.heading  = pairs_lib::AttitudeConverter(ret->pose.orientation).getHeading();
    }
  }
  ...
  pairs_msgs::msg::ReferenceStamped eqivalent_reference = velocityReferenceToReference(transformed_reference);
  ...
  // prepare the message for current tracker
  std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Request> reference_request = std::make_shared<pairs_msgs::srv::VelocityReferenceSrv::Request>();
  reference_request->reference                                                    = transformed_reference.reference;
...
pairs_lib::Task<std::tuple<bool, std::string, bool, std::vector<std::string>, std::vector<bool>, std::vector<std::string>>>
ControlManager::setTrajectoryReference(const pairs_msgs::msg::TrajectoryReference trajectory_in) {
...

  {
    ...
    for (int i = 0; i < int(trajectory_in.points.size()) - 1; i++) {
      ...
      new_pose.orientation = pairs_lib::AttitudeConverter(0, 0, trajectory_in.points.at(i).heading);
  ...
  pairs_msgs::msg::TrajectoryReference processed_trajectory = trajectory_in;
        ...
        if (!is_valid) {
          ...
          if (first_invalid_idx != -1) {
            ...
            if (last_valid_idx == -1) {
              ...
              double dist_two_points = pairs_lib::geometry::dist(
              ...
              for (int j = last_valid_idx; j < i; j++) {
                pairs_msgs::msg::ReferenceStamped temp_point;
...
void ControlManager::publishDiagnostics(void) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("publishDiagnostics");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::publishDiagnostics", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::msg::ControlManagerDiagnostics diagnostics_msg;
...

  {
    ...
    pairs_msgs::msg::ControllerStatus controller_status;
...
void ControlManager::setConstraintsToTrackers(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraintsToTrackers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::setConstraintsToTrackers", scope_timer_logger_, scope_timer_enabled_);

  std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> request = std::make_shared<pairs_msgs::srv::DynamicsConstraintsSrv::Request>(constraints);
...
void ControlManager::setConstraintsToControllers(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraintsToControllers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::setConstraintsToControllers", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::setConstraints(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraints");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::setConstraints", scope_timer_logger_, scope_timer_enabled_);
...
std::optional<pairs_msgs::srv::DynamicsConstraintsSrv::Request>
ControlManager::enforceControllersConstraints(const pairs_msgs::srv::DynamicsConstraintsSrv::Request &constraints) {
...
pairs_lib::Task<bool> ControlManager::isPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &point) {
...
pairs_lib::Task<bool> ControlManager::isPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &point) {
...
pairs_lib::Task<bool> ControlManager::isPathToPointInSafetyArea3d(const pairs_msgs::msg::ReferenceStamped &start, const pairs_msgs::msg::ReferenceStamped &end) {

  std::shared_ptr<pairs_msgs::srv::ValidatePathToPointSrv::Request> request = std::make_shared<pairs_msgs::srv::ValidatePathToPointSrv::Request>();
...
pairs_lib::Task<bool> ControlManager::isPathToPointInSafetyArea2d(const pairs_msgs::msg::ReferenceStamped &start, const pairs_msgs::msg::ReferenceStamped &end) {
...
pairs_lib::Task<double> ControlManager::getMaxZ(const std::string &frame_id) {

  double safety_area_max_z = std::numeric_limits<float>::max();

  {
    // | ------- first, get max_z from the safety area ------ |
    std::shared_ptr<pairs_msgs::srv::GetReferenceStampedSrv::Request> request = std::make_shared<pairs_msgs::srv::GetReferenceStampedSrv::Request>();
...
pairs_lib::Task<double> ControlManager::getMinZ(const std::string &frame_id) {
...
void ControlManager::bumperPushFromObstacle(void) {
  ...
  if (_bumper_horizontal_derive_from_dynamics_ || _bumper_vertical_derive_from_dynamics_) {
    ...
    auto constraints = pairs_lib::get_mutexed(mutex_constraints_, current_constraints_);
  ...
  // copy member variables
  pairs_msgs::msg::ObstacleSectors::ConstSharedPtr bumper_data = sh_bumper_.getMsg();
  auto                                           uav_state   = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  ...
  if (horizontal_collision_detected || vertical_collision_detected) {
    ...
    pairs_msgs::msg::ReferenceStamped reference_fcu_untilted;
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::ehover(void) {
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::eland(void) {
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::failsafe(void) {
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::escalatingFailsafe(void) {
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::arming(const bool input) {
...
pairs_lib::Task<> ControlManager::odometryCallbacksSrv(const bool input) {
...
pairs_lib::Task<bool> ControlManager::elandSrv(void) {
...
pairs_lib::Task<bool> ControlManager::parachuteSrv(void) {
...
pairs_lib::Task<> ControlManager::ungripSrv(void) {
...
std::tuple<bool, std::string> ControlManager::switchTracker(const std::string &tracker_name) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("switchTracker");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::switchTracker", scope_timer_logger_, scope_timer_enabled_);
...
std::tuple<bool, std::string> ControlManager::switchController(const std::string &controller_name) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("switchController");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::switchController", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::srv::DynamicsConstraintsSrv::Request sanitized_constraints;
...
pairs_lib::Task<> ControlManager::updateTrackers(void) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("updateTrackers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::updateTrackers", scope_timer_logger_, scope_timer_enabled_);
  ...
  std::optional<pairs_msgs::msg::TrackerCommand> tracker_command;
...
pairs_lib::Task<> ControlManager::updateControllers(const pairs_msgs::msg::UavState &uav_state) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("updateControllers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::updateControllers", scope_timer_logger_, scope_timer_enabled_);
  ...
  if (validateControlOutput(node_, control_output, _hw_api_inputs_, "control_output")) {
    ...
    pairs_lib::set_mutexed(mutex_last_control_output_, control_output, last_control_output_);
...
void ControlManager::publish(void) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("publish");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "ControlManager::publish", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::msg::HwApiAttitudeCmd attitude_target;
  ...
  if (throttle) {
    ...
    double thrust = pairs_lib::quadratic_throttle_model::throttleToForce(common_handlers_->throttle_model, throttle.value());
  ...
  if (last_control_output.control_output) {
    ...
    pairs_msgs::msg::EstimatorInput msg;
    ...
    if (last_control_output.desired_unbiased_acceleration) {
      ph_pairs_odom_input_.publish(msg);
    }
  }
}
...
pairs_lib::Task<std::tuple<bool, std::string>> ControlManager::deployParachute(void) {
...
pairs_msgs::msg::ReferenceStamped ControlManager::velocityReferenceToReference(const pairs_msgs::msg::VelocityReferenceStamped &vel_reference) {

  auto last_tracker_cmd    = pairs_lib::get_mutexed(mutex_last_tracker_cmd_, last_tracker_cmd_);
  auto uav_state           = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  auto current_constraints = pairs_lib::get_mutexed(mutex_constraints_, current_constraints_);

  pairs_msgs::msg::ReferenceStamped reference_out;
  ...
  if (vel_reference.reference.use_heading) {
    ...
    reference_out.reference.heading = pairs_lib::AttitudeConverter(uav_state.pose.orientation).getHeading() + vel_reference.reference.use_heading_rate;
  } else {
    reference_out.reference.heading = pairs_lib::AttitudeConverter(uav_state.pose.orientation).getHeading();
  }
...
void ControlManager::publishControlReferenceOdom(const std::optional<pairs_msgs::msg::TrackerCommand> &tracker_command,
  ...
  if (control_output.desired_orientation) {
    msg.pose.pose.orientation = pairs_lib::AttitudeConverter(control_output.desired_orientation.value());
  } else if (tracker_command->use_heading) {
    msg.pose.pose.orientation = pairs_lib::AttitudeConverter(0, 0, tracker_command->heading);
  }

  // fill in the attitude rate
  if (std::holds_alternative<pairs_msgs::msg::HwApiAttitudeRateCmd>(control_output.control_output.value())) {

    auto attitude_cmd = std::get<pairs_msgs::msg::HwApiAttitudeRateCmd>(control_output.control_output.value());
...
void ControlManager::initializeControlOutput(void) {
  ...
  pairs_lib::set_mutexed(mutex_last_control_output_, controller_output, last_control_output_);
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::control_manager::ControlManager)
