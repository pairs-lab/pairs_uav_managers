...
#include <pairs_lib/safety_zone/safety_zone.h>
...
#include <pairs_msgs/ReferenceArray.h>
#include <pairs_msgs/TrajectoryReference.h>

#include <pairs_msgs/ReferenceStampedSrv.h>
#include <pairs_msgs/ReferenceStampedSrvRequest.h>
#include <pairs_msgs/ReferenceStampedSrvResponse.h>

#include <pairs_msgs/VelocityReferenceStampedSrv.h>
#include <pairs_msgs/VelocityReferenceStampedSrvRequest.h>
#include <pairs_msgs/VelocityReferenceStampedSrvResponse.h>

#include <pairs_msgs/TransformReferenceSrv.h>
#include <pairs_msgs/TransformReferenceSrvRequest.h>
#include <pairs_msgs/TransformReferenceSrvResponse.h>

#include <pairs_msgs/TransformReferenceArraySrv.h>
#include <pairs_msgs/TransformReferenceArraySrvRequest.h>
#include <pairs_msgs/TransformReferenceArraySrvResponse.h>

#include <pairs_msgs/TransformPoseSrv.h>
#include <pairs_msgs/TransformPoseSrvRequest.h>
#include <pairs_msgs/TransformPoseSrvResponse.h>

#include <pairs_msgs/TransformVector3Srv.h>
#include <pairs_msgs/TransformVector3SrvRequest.h>
#include <pairs_msgs/TransformVector3SrvResponse.h>

#include <pairs_msgs/Float64StampedSrv.h>
#include <pairs_msgs/Float64StampedSrvRequest.h>
#include <pairs_msgs/Float64StampedSrvResponse.h>

#include <pairs_msgs/Vec4.h>
#include <pairs_msgs/Vec4Request.h>
#include <pairs_msgs/Vec4Response.h>

#include <pairs_msgs/Vec1.h>
#include <pairs_msgs/Vec1Request.h>
#include <pairs_msgs/Vec1Response.h>
...
private:
  ...
  std::vector<boost::shared_ptr<pairs_uav_managers::Tracker>>          tracker_list_;    // list of trackers, routines are callable from this
  ...
  std::vector<boost::shared_ptr<pairs_uav_managers::Controller>>          controller_list_;    // list of controllers, routines are callable from this
  ...
  pairs_msgs::UavState previous_uav_state_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped> sh_max_z_;
  ...
  pairs_lib::SubscribeHandler<nav_msgs::Odometry> sh_odometry_innovation_;
  ...
  pairs_lib::PublisherHandler<pairs_msgs::ControllerDiagnostics>     ph_controller_diagnostics_;
  pairs_lib::PublisherHandler<pairs_msgs::TrackerCommand>            ph_tracker_cmd_;
  pairs_lib::PublisherHandler<pairs_msgs::EstimatorInput>            ph_pairs_odom_input_;
  pairs_lib::PublisherHandler<nav_msgs::Odometry>                  ph_control_reference_odom_;
  pairs_lib::PublisherHandler<pairs_msgs::ControlManagerDiagnostics> ph_diagnostics_;
  pairs_lib::PublisherHandler<std_msgs::Empty>                     ph_offboard_on_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>            ph_tilt_error_;
  pairs_lib::PublisherHandler<std_msgs::Float64>                   ph_mass_estimate_;
  pairs_lib::PublisherHandler<std_msgs::Float64>                   ph_mass_nominal_;
  pairs_lib::PublisherHandler<std_msgs::Float64>                   ph_throttle_;
  pairs_lib::PublisherHandler<std_msgs::Float64>                   ph_thrust_;
  pairs_lib::PublisherHandler<pairs_msgs::ControlError>              ph_control_error_;
  pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>     ph_safety_area_markers_;
  pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>     ph_safety_area_coordinates_markers_;
  pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>     ph_disturbances_markers_;
  pairs_lib::PublisherHandler<pairs_msgs::DynamicsConstraints>       ph_current_constraints_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>            ph_heading_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>            ph_speed_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::ReferenceStamped> sh_reference_;

  // the velocity reference service and subscriber
  ros::ServiceServer                                            service_server_velocity_reference_;
  pairs_lib::SubscribeHandler<pairs_msgs::VelocityReferenceStamped> sh_velocity_reference_;

  // trajectory tracking
  ros::ServiceServer                                       service_server_trajectory_reference_;
  pairs_lib::SubscribeHandler<pairs_msgs::TrajectoryReference> sh_trajectory_reference_;
  ...
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_eland_;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_shutdown_;
  pairs_lib::ServiceClientHandler<std_srvs::SetBool> sch_set_odometry_callbacks_;
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_parachute_;
  ...
  std::optional<pairs_msgs::TrackerCommand> last_tracker_cmd_;
  ...
  // safety area
  std::unique_ptr<pairs_lib::SafetyZone> safety_zone_;
  ...
  bool   isPointInSafetyArea2d(const pairs_msgs::ReferenceStamped& point);
  bool   isPointInSafetyArea3d(const pairs_msgs::ReferenceStamped& point);
  bool   isPathToPointInSafetyArea2d(const pairs_msgs::ReferenceStamped& from, const pairs_msgs::ReferenceStamped& to);
  bool   isPathToPointInSafetyArea3d(const pairs_msgs::ReferenceStamped& from, const pairs_msgs::ReferenceStamped& to);
  ...
  void callbackUavState(const pairs_msgs::UavState::ConstPtr msg);
  ...
  void callbackRC(const pairs_msgs::HwApiRcChannels::ConstPtr msg);

  // topic timeouts
  void timeoutUavState(const double& missing_for);

  // switching controller and tracker services
  bool callbackSwitchTracker(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res);
  bool callbackSwitchController(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res);
  bool callbackTrackerResetStatic(std_srvs::Trigger::Request& req, std_srvs::Trigger::Response& res);

  // reference callbacks
  void callbackReferenceTopic(const pairs_msgs::ReferenceStamped::ConstPtr msg);
  void callbackVelocityReferenceTopic(const pairs_msgs::VelocityReferenceStamped::ConstPtr msg);
  void callbackTrajectoryReferenceTopic(const pairs_msgs::TrajectoryReference::ConstPtr msg);
  bool callbackGoto(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res);
  bool callbackGotoFcu(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res);
  bool callbackGotoRelative(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res);
  bool callbackGotoAltitude(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res);
  bool callbackSetHeading(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res);
  bool callbackSetHeadingRelative(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res);
  bool callbackReferenceService(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res);
  bool callbackVelocityReferenceService(pairs_msgs::VelocityReferenceStampedSrv::Request& req, pairs_msgs::VelocityReferenceStampedSrv::Response& res);
  bool callbackTrajectoryReferenceService(pairs_msgs::TrajectoryReferenceSrv::Request& req, pairs_msgs::TrajectoryReferenceSrv::Response& res);
  bool callbackEmergencyReference(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res);
  ...
  bool callbackSetMinZ(pairs_msgs::Float64StampedSrv::Request& req, pairs_msgs::Float64StampedSrv::Response& res);
  ...
  bool callbackGetMinZ(pairs_msgs::GetFloat64::Request& req, pairs_msgs::GetFloat64::Response& res);

  bool callbackValidateReference(pairs_msgs::ValidateReference::Request& req, pairs_msgs::ValidateReference::Response& res);
  bool callbackValidateReference2d(pairs_msgs::ValidateReference::Request& req, pairs_msgs::ValidateReference::Response& res);
  bool callbackValidateReferenceArray(pairs_msgs::ValidateReferenceArray::Request& req, pairs_msgs::ValidateReferenceArray::Response& res);

  // transformation callbacks
  bool callbackTransformReference(pairs_msgs::TransformReferenceSrv::Request& req, pairs_msgs::TransformReferenceSrv::Response& res);
  bool callbackTransformReferenceArray(pairs_msgs::TransformReferenceArraySrv::Request& req, pairs_msgs::TransformReferenceArraySrv::Response& res);
  bool callbackTransformPose(pairs_msgs::TransformPoseSrv::Request& req, pairs_msgs::TransformPoseSrv::Response& res);
  bool callbackTransformVector3(pairs_msgs::TransformVector3Srv::Request& req, pairs_msgs::TransformVector3Srv::Response& res);

  // | ----------------------- constraints ---------------------- |

  // sets constraints to all trackers
  bool callbackSetConstraints(pairs_msgs::DynamicsConstraintsSrv::Request& req, pairs_msgs::DynamicsConstraintsSrv::Response& res);

  // constraints management
  bool              got_constraints_ = false;
  std::mutex        mutex_constraints_;
  void              setConstraints(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints);
  void              setConstraintsToTrackers(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints);
  void              setConstraintsToControllers(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints);
  std::atomic<bool> constraints_being_enforced_ = false;

  std::optional<pairs_msgs::DynamicsConstraintsSrvRequest> enforceControllersConstraints(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints);

  pairs_msgs::DynamicsConstraintsSrvRequest current_constraints_;
  pairs_msgs::DynamicsConstraintsSrvRequest sanitized_constraints_;
  ...
  // bumper subscriber
  pairs_lib::SubscribeHandler<pairs_msgs::ObstacleSectors> sh_bumper_;
  ...
  void                                             ungripSrv(void);
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_ungrip_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::HwApiRcChannels> sh_hw_api_rc_;
  ...
  pairs_lib::PublisherHandler<geometry_msgs::PoseArray>        pub_debug_original_trajectory_poses_;
  pairs_lib::PublisherHandler<visualization_msgs::MarkerArray> pub_debug_original_trajectory_markers_;
  ...
  void updateControllers(const pairs_msgs::UavState& uav_state);

  // sets the reference to the active tracker
  std::tuple<bool, std::string> setReference(const pairs_msgs::ReferenceStamped reference_in);

  // sets the velocity reference to the active tracker
  std::tuple<bool, std::string> setVelocityReference(const pairs_msgs::VelocityReferenceStamped& reference_in);
  ...
  std::tuple<bool, std::string, bool, std::vector<std::string>, std::vector<bool>, std::vector<std::string>> setTrajectoryReference(
      const pairs_msgs::TrajectoryReference trajectory_in);
  ...
  void publishControlReferenceOdom(const std::optional<pairs_msgs::TrackerCommand>& tracker_command, const Controller::ControlOutput& control_output);
  ...
  pairs_msgs::ReferenceStamped velocityReferenceToReference(const pairs_msgs::VelocityReferenceStamped& vel_reference);
...
void ControlManager::preinitialize(void) {
  ...
  sh_hw_api_capabilities_ = pairs_lib::SubscribeHandler<pairs_msgs::HwApiCapabilities>(shopts, "hw_api_capabilities_in");
...
void ControlManager::initialize(void) {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "ControlManager");
  ...
  if (use_safety_area_) {
    ...
    try {
      ...
      safety_zone_ = std::make_unique<pairs_lib::SafetyZone>(border_points);
    }

    catch (pairs_lib::SafetyZone::BorderError& e) {
  ...
  param_loader.setPrefix("pairs_uav_managers/control_manager/");
  ...
  transformer_ = std::make_shared<pairs_lib::Transformer>(nh_, "ControlManager");
  ...
  param_loader.loadParam("pairs_trackers", _tracker_names_);
  ...
  for (int i = 0; i < int(tracker_list_.size()); i++) {
    ...
    private_handlers->param_loader   = std::make_unique<pairs_lib::ParamLoader>(ros::NodeHandle(nh_, it->second.name_space), _tracker_names_.at(i));
  ...
  param_loader.loadParam("pairs_controllers", _controller_names_);
  ...
  for (int i = 0; i < int(controller_list_.size()); i++) {
    ...
    private_handlers->param_loader   = std::make_unique<pairs_lib::ParamLoader>(ros::NodeHandle(nh_, it->second.name_space), _controller_names_.at(i));
  ...
  profiler_ = pairs_lib::Profiler(nh_, "ControlManager", _profiler_enabled_);

  // | ----------------------- publishers ----------------------- |

  control_output_publisher_ = OutputPublisher(nh_);

  ph_controller_diagnostics_             = pairs_lib::PublisherHandler<pairs_msgs::ControllerDiagnostics>(nh_, "controller_diagnostics_out", 1);
  ph_tracker_cmd_                        = pairs_lib::PublisherHandler<pairs_msgs::TrackerCommand>(nh_, "tracker_cmd_out", 1);
  ph_pairs_odom_input_                     = pairs_lib::PublisherHandler<pairs_msgs::EstimatorInput>(nh_, "estimator_input_out", 1);
  ph_control_reference_odom_             = pairs_lib::PublisherHandler<nav_msgs::Odometry>(nh_, "control_reference_out", 1);
  ph_diagnostics_                        = pairs_lib::PublisherHandler<pairs_msgs::ControlManagerDiagnostics>(nh_, "diagnostics_out", 1);
  ph_offboard_on_                        = pairs_lib::PublisherHandler<std_msgs::Empty>(nh_, "offboard_on_out", 1);
  ph_tilt_error_                         = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh_, "tilt_error_out", 1);
  ph_mass_estimate_                      = pairs_lib::PublisherHandler<std_msgs::Float64>(nh_, "mass_estimate_out", 1, false, 10.0);
  ph_mass_nominal_                       = pairs_lib::PublisherHandler<std_msgs::Float64>(nh_, "mass_nominal_out", 1, true);
  ph_throttle_                           = pairs_lib::PublisherHandler<std_msgs::Float64>(nh_, "throttle_out", 1, false, 10.0);
  ph_thrust_                             = pairs_lib::PublisherHandler<std_msgs::Float64>(nh_, "thrust_out", 1, false, 100.0);
  ph_control_error_                      = pairs_lib::PublisherHandler<pairs_msgs::ControlError>(nh_, "control_error_out", 1);
  ph_safety_area_markers_                = pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>(nh_, "safety_area_markers_out", 1, true, 1.0);
  ph_safety_area_coordinates_markers_    = pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>(nh_, "safety_area_coordinates_markers_out", 1, true, 1.0);
  ph_disturbances_markers_               = pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>(nh_, "disturbances_markers_out", 1, false, 10.0);
  ph_current_constraints_                = pairs_lib::PublisherHandler<pairs_msgs::DynamicsConstraints>(nh_, "current_constraints_out", 1);
  ph_heading_                            = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh_, "heading_out", 1);
  ph_speed_                              = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh_, "speed_out", 1, false, 10.0);
  pub_debug_original_trajectory_poses_   = pairs_lib::PublisherHandler<geometry_msgs::PoseArray>(nh_, "trajectory_original/poses_out", 1, true);
  pub_debug_original_trajectory_markers_ = pairs_lib::PublisherHandler<visualization_msgs::MarkerArray>(nh_, "trajectory_original/markers_out", 1, true);
  ...
  if (_state_input_ == INPUT_UAV_STATE) {
    sh_uav_state_ = pairs_lib::SubscribeHandler<pairs_msgs::UavState>(shopts, "uav_state_in", &ControlManager::callbackUavState, this);
  } else if (_state_input_ == INPUT_ODOMETRY) {
    sh_odometry_ = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, "odometry_in", &ControlManager::callbackOdometry, this);
  }

  if (_odometry_innovation_check_enabled_) {
    sh_odometry_innovation_ = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, "odometry_innovation_in");
  }

  sh_bumper_    = pairs_lib::SubscribeHandler<pairs_msgs::ObstacleSectors>(shopts, "bumper_sectors_in");
  sh_max_z_     = pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped>(shopts, "max_z_in");
  sh_joystick_  = pairs_lib::SubscribeHandler<sensor_msgs::Joy>(shopts, "joystick_in", &ControlManager::callbackJoystick, this);
  sh_gnss_      = pairs_lib::SubscribeHandler<sensor_msgs::NavSatFix>(shopts, "gnss_in", &ControlManager::callbackGNSS, this);
  sh_hw_api_rc_ = pairs_lib::SubscribeHandler<pairs_msgs::HwApiRcChannels>(shopts, "hw_api_rc_in", &ControlManager::callbackRC, this);

  sh_hw_api_status_ = pairs_lib::SubscribeHandler<pairs_msgs::HwApiStatus>(shopts, "hw_api_status_in", &ControlManager::callbackHwApiStatus, this);
  ...
  sch_arming_                 = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "hw_api_arming_out");
  sch_eland_                  = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "eland_out");
  sch_shutdown_               = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "shutdown_out");
  sch_set_odometry_callbacks_ = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "set_odometry_callbacks_out");
  sch_ungrip_                 = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "ungrip_out");
  sch_parachute_              = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "parachute_out");
  ...
  sh_reference_             = pairs_lib::SubscribeHandler<pairs_msgs::ReferenceStamped>(shopts, "reference_in", &ControlManager::callbackReferenceTopic, this);
  ...
  sh_velocity_reference_ =
      pairs_lib::SubscribeHandler<pairs_msgs::VelocityReferenceStamped>(shopts, "velocity_reference_in", &ControlManager::callbackVelocityReferenceTopic, this);
  ...
  sh_trajectory_reference_ =
      pairs_lib::SubscribeHandler<pairs_msgs::TrajectoryReference>(shopts, "trajectory_reference_in", &ControlManager::callbackTrajectoryReferenceTopic, this);
...
void ControlManager::timerHwApiCapabilities(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerHwApiCapabilities", _status_timer_rate_, 1.0, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerHwApiCapabilities", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::timerStatus(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerStatus", _status_timer_rate_, 0.1, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerStatus", scope_timer_logger_, scope_timer_enabled_);
  ...
  // --------------------------------------------------------------
  {
    ...
    if (tilt_error_) {
      ...
      pairs_msgs::Float64Stamped tilt_error_out;
  ...
  if (position_error) {
    ...
    pairs_msgs::ControlError msg_out;
  ...
  if (_state_input_ == INPUT_UAV_STATE && sh_uav_state_.hasMsg()) {
    ...
    try {
      ...
      pairs_msgs::Float64Stamped heading_out;
  ...
  if (_state_input_ == INPUT_UAV_STATE && sh_uav_state_.hasMsg()) {
    ...
    pairs_msgs::Float64Stamped speed_out;
  ...
  if (use_safety_area_) {
    ...
    if (ret) {
      ...
      pairs_lib::Polygon border = safety_zone_->getBorder();
      ...
      safety_area_marker.pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
      ...
      safety_area_coordinates_marker.pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
  ...
  if (got_constraints_) {
    ...
    pairs_msgs::DynamicsConstraints constraints = sanitized_constraints.constraints;
...
void ControlManager::timerSafety(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerSafety", _safety_timer_rate_, 0.05, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerSafety", scope_timer_logger_, scope_timer_enabled_);
...

  {
    ...
    if (last_tracker_cmd->use_position_horizontal && !std::holds_alternative<pairs_msgs::HwApiPositionCmd>(last_control_output.control_output.value())) {
    ...
    if (last_tracker_cmd->use_position_vertical && !std::holds_alternative<pairs_msgs::HwApiPositionCmd>(last_control_output.control_output.value())) {
...
void ControlManager::timerEland(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerEland", _elanding_timer_rate_, 0.01, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerEland", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::timerFailsafe(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerFailsafe", _failsafe_timer_rate_, 0.01, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerFailsafe", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::timerJoystick(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerJoystick", _status_timer_rate_, 0.05, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerJoystick", scope_timer_logger_, scope_timer_enabled_);
  ...
  if (joystick_goto_enabled_ && sh_joystick_.hasMsg()) {
    ...
    pairs_msgs::Vec4::Request request;
    ...
    if (fabs(joystick_data->axes.at(_channel_pitch_)) >= 0.05 || fabs(joystick_data->axes.at(_channel_roll_)) >= 0.05 ||
      ...
      if (_joystick_mode_ == 0) {
        ...
        pairs_msgs::Vec4::Response response;
  ...
  if (rc_goto_active_ && !bumper_repulsing_ && last_tracker_cmd && sh_hw_api_rc_.hasMsg()) {
    ...
    // create the reference
    pairs_msgs::VelocityReferenceStampedSrv::Request request;
    ...
    // copy member variables
    pairs_msgs::HwApiRcChannelsConstPtr rc_channels = sh_hw_api_rc_.getMsg();
    ...
    if (!nothing_to_do) {
      ...
      pairs_msgs::VelocityReferenceStampedSrv::Response response;
...
void ControlManager::timerBumper(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerBumper", _bumper_timer_rate_, 0.05, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerBumper", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::timerPirouette(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("timerPirouette", _pirouette_timer_rate_, 0.01, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::timerPirouette", scope_timer_logger_, scope_timer_enabled_);
  ...
  // set the reference
  pairs_msgs::ReferenceStamped reference_request;
...
void ControlManager::asyncControl(void) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::asyncControl", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackOdometry(const nav_msgs::Odometry::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackOdometry", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::UavState uav_state_odom;
...

  {
    ...
    uav_state_ = pairs_msgs::UavState();
    ...
    std::tie(uav_roll_, uav_pitch_, uav_yaw_) = pairs_lib::AttitudeConverter(odom->pose.pose.orientation);

    try {
      uav_heading_ = pairs_lib::AttitudeConverter(odom->pose.pose.orientation).getHeading();
    }
    catch (...) {
...
void ControlManager::callbackUavState(const pairs_msgs::UavState::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackUavState", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::UavStateConstPtr uav_state = msg;
...
void ControlManager::callbackGNSS(const sensor_msgs::NavSatFix::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackGNSS", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackJoystick(const sensor_msgs::Joy::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackJoystick", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackHwApiStatus(const pairs_msgs::HwApiStatus::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackHwApiStatus", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::HwApiStatusConstPtr state = msg;
...
void ControlManager::callbackRC(const pairs_msgs::HwApiRcChannels::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackRC", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::HwApiRcChannelsConstPtr rc = msg;
...
bool ControlManager::callbackSwitchTracker(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res) {
...
bool ControlManager::callbackSwitchController(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res) {
...
bool ControlManager::callbackSetMinZ([[maybe_unused]] pairs_msgs::Float64StampedSrv::Request& req, pairs_msgs::Float64StampedSrv::Response& res) {
  ...
  pairs_msgs::ReferenceStamped point;
...
bool ControlManager::callbackToggleOutput(std_srvs::SetBool::Request& req, std_srvs::SetBool::Response& res) {
  ...
  {
    pairs_msgs::ReferenceStamped current_coord;
...
bool ControlManager::callbackSetConstraints(pairs_msgs::DynamicsConstraintsSrv::Request& req, pairs_msgs::DynamicsConstraintsSrv::Response& res) {
...
bool ControlManager::callbackEmergencyReference(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res) {
  ...
  pairs_msgs::ReferenceSrvResponse::ConstPtr tracker_response;

  std::stringstream ss;

  // transform the reference to the current frame
  pairs_msgs::ReferenceStamped original_reference;
  ...
  pairs_msgs::ReferenceStamped transformed_reference = ret.value();

  std_srvs::SetBoolRequest req_enable_callbacks;

  pairs_msgs::ReferenceSrvRequest req_goto_out;
...

  {
    ...
    tracker_response = tracker_list_.at(active_tracker_idx_)
                           ->setReference(pairs_msgs::ReferenceSrvRequest::ConstPtr(std::make_unique<pairs_msgs::ReferenceSrvRequest>(req_goto_out)));
    ...
    if (tracker_response != pairs_msgs::ReferenceSrvResponse::Ptr()) {
...
bool ControlManager::callbackTransformReference(pairs_msgs::TransformReferenceSrv::Request& req, pairs_msgs::TransformReferenceSrv::Response& res) {
  ...
  // transform the reference to the current frame
  pairs_msgs::ReferenceStamped transformed_reference = req.reference;
...
bool ControlManager::callbackTransformReferenceArray(pairs_msgs::TransformReferenceArraySrv::Request& req, pairs_msgs::TransformReferenceArraySrv::Response& res) {
...
bool ControlManager::callbackTransformPose(pairs_msgs::TransformPoseSrv::Request& req, pairs_msgs::TransformPoseSrv::Response& res) {
...
bool ControlManager::callbackTransformVector3(pairs_msgs::TransformVector3Srv::Request& req, pairs_msgs::TransformVector3Srv::Response& res) {
...
bool ControlManager::callbackGetMinZ([[maybe_unused]] pairs_msgs::GetFloat64::Request& req, pairs_msgs::GetFloat64::Response& res) {
...
bool ControlManager::callbackValidateReference(pairs_msgs::ValidateReference::Request& req, pairs_msgs::ValidateReference::Response& res) {
  ...
  if (last_tracker_cmd) {
    ...
    pairs_msgs::ReferenceStamped from_point;
...
bool ControlManager::callbackValidateReference2d(pairs_msgs::ValidateReference::Request& req, pairs_msgs::ValidateReference::Response& res) {
...
bool ControlManager::callbackValidateReferenceArray(pairs_msgs::ValidateReferenceArray::Request& req, pairs_msgs::ValidateReferenceArray::Response& res) {
...
bool ControlManager::callbackReferenceService(pairs_msgs::ReferenceStampedSrv::Request& req, pairs_msgs::ReferenceStampedSrv::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackReferenceService", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::ReferenceStamped des_reference;
...
void ControlManager::callbackReferenceTopic(const pairs_msgs::ReferenceStamped::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackVelocityReferenceService(pairs_msgs::VelocityReferenceStampedSrv::Request&  req,
                                                      pairs_msgs::VelocityReferenceStampedSrv::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackVelocityReferenceService", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::VelocityReferenceStamped des_reference;
...
void ControlManager::callbackVelocityReferenceTopic(const pairs_msgs::VelocityReferenceStamped::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackVelocityReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackTrajectoryReferenceService(pairs_msgs::TrajectoryReferenceSrv::Request& req, pairs_msgs::TrajectoryReferenceSrv::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackTrajectoryReferenceService", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::callbackTrajectoryReferenceTopic(const pairs_msgs::TrajectoryReference::ConstPtr msg) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackTrajectoryReferenceTopic", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackGoto(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackGoto", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackGotoFcu(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackGotoFcu", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackGotoRelative(pairs_msgs::Vec4::Request& req, pairs_msgs::Vec4::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackGotoRelative", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackGotoAltitude(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackGotoAltitude", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackSetHeading(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackSetHeading", scope_timer_logger_, scope_timer_enabled_);
...
bool ControlManager::callbackSetHeadingRelative(pairs_msgs::Vec1::Request& req, pairs_msgs::Vec1::Response& res) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::callbackSetHeadingRelative", scope_timer_logger_, scope_timer_enabled_);
...
std::tuple<bool, std::string> ControlManager::setReference(const pairs_msgs::ReferenceStamped reference_in) {
  ...
  pairs_msgs::ReferenceSrvRequest reference_request;
...

  {
    ...
    tracker_response = tracker_list_.at(active_tracker_idx_)
                           ->setReference(pairs_msgs::ReferenceSrvRequest::ConstPtr(std::make_unique<pairs_msgs::ReferenceSrvRequest>(reference_request)));
...
std::tuple<bool, std::string> ControlManager::setVelocityReference(const pairs_msgs::VelocityReferenceStamped& reference_in) {
  ...
  pairs_msgs::VelocityReferenceStamped transformed_reference = reference_in;
  ...
  pairs_msgs::ReferenceStamped eqivalent_reference = velocityReferenceToReference(transformed_reference);
  ...
  pairs_msgs::VelocityReferenceSrvResponse::ConstPtr tracker_response;

  // prepare the message for current tracker
  pairs_msgs::VelocityReferenceSrvRequest reference_request;
  reference_request.reference = transformed_reference.reference;

  {
    ...
    tracker_response =
        tracker_list_.at(active_tracker_idx_)
            ->setVelocityReference(pairs_msgs::VelocityReferenceSrvRequest::ConstPtr(std::make_unique<pairs_msgs::VelocityReferenceSrvRequest>(reference_request)));

    if (tracker_response != pairs_msgs::VelocityReferenceSrvResponse::Ptr()) {
...
std::tuple<bool, std::string, bool, std::vector<std::string>, std::vector<bool>, std::vector<std::string>> ControlManager::setTrajectoryReference(
  ...
  pairs_msgs::TrajectoryReference processed_trajectory = trajectory_in;
        ...
        if (first_invalid_idx != -1) {
          ...
          if (last_valid_idx == -1) {
            ...
            for (int j = last_valid_idx; j < i; j++) {
              ...
              pairs_msgs::ReferenceStamped temp_point;
  ...
  for (int i = 0; i < trajectory_size; i++) {
    ...
    pairs_msgs::ReferenceStamped trajectory_point;
  ...
  pairs_msgs::TrajectoryReferenceSrvResponse::ConstPtr response;
  pairs_msgs::TrajectoryReferenceSrvRequest            request;
...

  {
    ...
    response =
        tracker_list_.at(active_tracker_idx_)
            ->setTrajectoryReference(pairs_msgs::TrajectoryReferenceSrvRequest::ConstPtr(std::make_unique<pairs_msgs::TrajectoryReferenceSrvRequest>(request)));

    tracker_names.push_back(_tracker_names_.at(active_tracker_idx_));

    if (response != pairs_msgs::TrajectoryReferenceSrvResponse::Ptr()) {
    ...
    for (size_t i = 0; i < tracker_list_.size(); i++) {
      ...
      if (i != active_tracker_idx_) {
        ...
        response = tracker_list_.at(i)->setTrajectoryReference(
            pairs_msgs::TrajectoryReferenceSrvRequest::ConstPtr(std::make_unique<pairs_msgs::TrajectoryReferenceSrvRequest>(request)));
...
bool ControlManager::isOffboard(void) {
  ...
  pairs_msgs::HwApiStatusConstPtr hw_api_status = sh_hw_api_status_.getMsg();
...
void ControlManager::publishDiagnostics(void) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::publishDiagnostics", scope_timer_logger_, scope_timer_enabled_);

  std::scoped_lock lock(mutex_diagnostics_);

  pairs_msgs::ControlManagerDiagnostics diagnostics_msg;
...
void ControlManager::setConstraintsToTrackers(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraintsToTrackers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::setConstraintsToTrackers", scope_timer_logger_, scope_timer_enabled_);

  pairs_msgs::DynamicsConstraintsSrvResponse::ConstPtr response;

  {
    ...
    for (int i = 0; i < int(tracker_list_.size()); i++) {
      ...
      response = tracker_list_.at(i)->setConstraints(
          pairs_msgs::DynamicsConstraintsSrvRequest::ConstPtr(std::make_unique<pairs_msgs::DynamicsConstraintsSrvRequest>(constraints)));
    }
  }
}
...
void ControlManager::setConstraintsToControllers(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraintsToControllers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::setConstraintsToControllers", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::setConstraints(const pairs_msgs::DynamicsConstraintsSrvRequest& constraints) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("setConstraints");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::setConstraints", scope_timer_logger_, scope_timer_enabled_);
...
std::optional<pairs_msgs::DynamicsConstraintsSrvRequest> ControlManager::enforceControllersConstraints(
    const pairs_msgs::DynamicsConstraintsSrvRequest& constraints) {
...
bool ControlManager::isPointInSafetyArea3d(const pairs_msgs::ReferenceStamped& point) {
...
bool ControlManager::isPointInSafetyArea2d(const pairs_msgs::ReferenceStamped& point) {
...
bool ControlManager::isPathToPointInSafetyArea3d(const pairs_msgs::ReferenceStamped& start, const pairs_msgs::ReferenceStamped& end) {
  ...
  pairs_msgs::ReferenceStamped start_transformed, end_transformed;
...
bool ControlManager::isPathToPointInSafetyArea2d(const pairs_msgs::ReferenceStamped& start, const pairs_msgs::ReferenceStamped& end) {
...
void ControlManager::bumperPushFromObstacle(void) {
  ...
  // copy member variables
  pairs_msgs::ObstacleSectorsConstPtr bumper_data = sh_bumper_.getMsg();
  auto                              uav_state   = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  ...
  if (horizontal_collision_detected || vertical_collision_detected) {
    ...
    pairs_msgs::ReferenceStamped reference_fcu_untilted;
...
std::tuple<bool, std::string> ControlManager::switchTracker(const std::string& tracker_name) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::switchTracker", scope_timer_logger_, scope_timer_enabled_);
...
std::tuple<bool, std::string> ControlManager::switchController(const std::string& controller_name) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::switchController", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::DynamicsConstraintsSrvRequest sanitized_constraints;
...
void ControlManager::updateTrackers(void) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::updateTrackers", scope_timer_logger_, scope_timer_enabled_);
  ...
  std::optional<pairs_msgs::TrackerCommand> tracker_command;
...
void ControlManager::updateControllers(const pairs_msgs::UavState& uav_state) {

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("updateControllers");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::updateControllers", scope_timer_logger_, scope_timer_enabled_);
...
void ControlManager::publish(void) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("ControlManager::publish", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::HwApiAttitudeCmd attitude_target;
  attitude_target.stamp = ros::Time::now();

  pairs_msgs::HwApiAttitudeRateCmd attitude_rate_target;
...
pairs_msgs::ReferenceStamped ControlManager::velocityReferenceToReference(const pairs_msgs::VelocityReferenceStamped& vel_reference) {

  auto last_tracker_cmd    = pairs_lib::get_mutexed(mutex_last_tracker_cmd_, last_tracker_cmd_);
  auto uav_state           = pairs_lib::get_mutexed(mutex_uav_state_, uav_state_);
  auto current_constraints = pairs_lib::get_mutexed(mutex_constraints_, current_constraints_);

  pairs_msgs::ReferenceStamped reference_out;
...
void ControlManager::publishControlReferenceOdom([[maybe_unused]] const std::optional<pairs_msgs::TrackerCommand>& tracker_command,
  ...
  if (std::holds_alternative<pairs_msgs::HwApiAttitudeRateCmd>(control_output.control_output.value())) {

    auto attitude_cmd = std::get<pairs_msgs::HwApiAttitudeRateCmd>(control_output.control_output.value());
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_managers::control_manager::ControlManager, nodelet::Nodelet)
