...
public:
  ...
  std::tuple<bool, std::string> activate([[maybe_unused]] const std::optional<pairs_msgs::msg::TrackerCommand> &last_tracker_cmd);
...
bool NullTracker::initialize(const rclcpp::Node::SharedPtr &node, std::shared_ptr<pairs_uav_managers::control_manager::CommonHandlers_t> common_handlers,
                             std::shared_ptr<pairs_uav_managers::control_manager::PrivateHandlers_t> private_handlers) {
...
std::tuple<bool, std::string> NullTracker::activate([[maybe_unused]] const std::optional<pairs_msgs::msg::TrackerCommand> &last_tracker_cmd) {
...
const std::shared_ptr<std_srvs::srv::Trigger::Response> NullTracker::switchOdometrySource([[maybe_unused]] const pairs_msgs::msg::UavState &new_uav_state) {
  return nullptr;
}
...
std::optional<pairs_msgs::msg::TrackerCommand> NullTracker::update([[maybe_unused]] const pairs_msgs::msg::UavState                     &uav_state,
...
const pairs_msgs::msg::TrackerStatus NullTracker::getStatus() {
...
NullTracker::setReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Request> &request) {
...
const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Response>
NullTracker::setVelocityReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Request> &request) {
...
const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Response>
NullTracker::setTrajectoryReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request> &request) {
...
const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
NullTracker::setConstraints([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &request) {
