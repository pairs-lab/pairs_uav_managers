...
class GainManager : public pairs_lib::Node {
...
private:
  ...
  pairs_lib::ServiceClientHandler<rcl_interfaces::srv::SetParameters> sc_set_gains_;
  ...
  pairs_lib::Task<bool> setGains(std::string gains_name);

  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String> ss_set_gains_;

  pairs_lib::Task<bool> callbackSetGains(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
  ...
  pairs_lib::Task<>            timerGainManagement();
  ...
  //
  pairs_lib::PublisherHandler<pairs_msgs::msg::GainManagerDiagnostics> ph_diagnostics_;
...
GainManager::GainManager(rclcpp::NodeOptions options) : pairs_lib::Node("control_manager", options) {
...
void GainManager::initialize() {
  ...
  error_publisher_ = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "GainManager", "main");
  ...
  const std::string yaml_prefix = "pairs_uav_managers/gain_manager/";
  ...
  ss_set_gains_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(node_, "~/set_gains_in", &GainManager::callbackSetGains, this,
                                                                       rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  sc_set_gains_ = pairs_lib::ServiceClientHandler<rcl_interfaces::srv::SetParameters>(node_, "~/set_gains_out", cbkgrp_sc_);
  ...
  ph_diagnostics_ = pairs_lib::PublisherHandler<pairs_msgs::msg::GainManagerDiagnostics>(node_, "~/diagnostics_out");
  ...
  profiler_ = pairs_lib::Profiler(node_, "GainManager", _profiler_enabled_);
...
pairs_lib::Task<bool> GainManager::setGains(std::string gains_name) {
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kpxy";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kvxy";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kaxy";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/attitude.kq_roll_pitch";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kibxy";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kiwxy";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kibxy_lim";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/horizontal.kiwxy_lim";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/vertical.kpz";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/vertical.kvz";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/vertical.kaz";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/attitude.kq_yaw";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/mass.km";
...

  {
    ...
    param.name = "pairs_uav_controllers/se3_controller/mass.km_lim";
  ...
  if (!response) {
    ...
    pairs_lib::set_mutexed(mutex_current_gains_, gains_name, current_gains_);
    co_return true;
  }
}
...
pairs_lib::Task<bool> GainManager::callbackSetGains(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
                                                  const std::shared_ptr<pairs_msgs::srv::String::Response> response) {
...
pairs_lib::Task<> GainManager::timerGainManagement() {

  if (!is_initialized_) {
    co_return;
  }

  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("gainManagementTimer");
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "GainManager::gainManagementTimer", scope_timer_logger_, scope_timer_enabled_);
  ...
  auto current_gains       = pairs_lib::get_mutexed(mutex_current_gains_, current_gains_);
...
void GainManager::timerDiagnostics() {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer(node_, "GainManager::timerDiagnostics", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::msg::GainManagerDiagnostics diagnostics;
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::gain_manager::GainManager)
