...
private:
  ...
  bool               callbackSetGains(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res);
  ...
  pairs_lib::PublisherHandler<pairs_msgs::GainManagerDiagnostics> ph_diagnostics_;
...
void GainManager::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "GainManager");
  ...
  ph_diagnostics_ = pairs_lib::PublisherHandler<pairs_msgs::GainManagerDiagnostics>(nh_, "diagnostics_out", 10);
  ...
  profiler_ = pairs_lib::Profiler(nh_, "GainManager", _profiler_enabled_);
...
bool GainManager::callbackSetGains(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res) {
...
void GainManager::timerGainManagement(const ros::TimerEvent& event) {
  ...
  pairs_lib::Routine    profiler_routine = profiler_.createRoutine("gainManagementTimer", _gain_management_rate_, 0.01, event);
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("GainManager::gainManagementTimer", scope_timer_logger_, scope_timer_enabled_);
...
void GainManager::timerDiagnostics(const ros::TimerEvent& event) {
  ...
  pairs_lib::ScopeTimer timer            = pairs_lib::ScopeTimer("GainManager::timerDiagnostics", scope_timer_logger_, scope_timer_enabled_);
  ...
  pairs_msgs::GainManagerDiagnostics diagnostics;
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_managers::gain_manager::GainManager, nodelet::Nodelet)
