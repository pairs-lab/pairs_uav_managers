...
void AglEstimator::publishAglHeight() const {
  ph_agl_height_.publish(pairs_lib::get_mutexed(mtx_agl_height_, agl_height_));
}
/*//}*/
...
void AglEstimator::publishCovariance() const {
  ...
  ph_agl_height_cov_.publish(pairs_lib::get_mutexed(mtx_agl_height_, agl_height_cov_));
}
/*//}*/

/*//{ isCompatibleWithHwApi() */
bool AglEstimator::isCompatibleWithHwApi(const pairs_msgs::msg::HwApiCapabilities::ConstSharedPtr &hw_api_capabilities) const {
