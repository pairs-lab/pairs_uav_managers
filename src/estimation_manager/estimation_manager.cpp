...
private:
  ...
  pairs_lib::PublisherHandler<pairs_msgs::EstimationDiagnostics> ph_diagnostics_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>        ph_max_flight_z_;
  pairs_lib::PublisherHandler<pairs_msgs::UavState>              ph_uav_state_;
  pairs_lib::PublisherHandler<nav_msgs::Odometry>              ph_odom_main_;
  pairs_lib::PublisherHandler<nav_msgs::Odometry>              ph_odom_slow_;  // use topic throttler instead?
  pairs_lib::PublisherHandler<nav_msgs::Odometry>              ph_innovation_;

  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped> ph_altitude_amsl_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped> ph_altitude_agl_;
  ...
  bool               callbackChangeEstimator(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res);
  int                estimator_switch_count_ = 0;

  ros::ServiceServer srvs_reset_estimator_;
  bool               callbackResetEstimator(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res);
  ...
  /* pairs_lib::ServiceClientHandler<std_srvs::Trigger> srvc_hover_; */
  /* pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv> srvc_reference_; */
  /* pairs_lib::ServiceClientHandler<std_srvs::Trigger> srvc_ehover_; */
  /* pairs_lib::ServiceClientHandler<std_srvs::SetBool> srvc_enable_callbacks_; */
  ...
  std::vector<boost::shared_ptr<pairs_uav_managers::StateEstimator>>          estimator_list_;          // list of estimators
  ...
  boost::shared_ptr<pairs_uav_managers::StateEstimator>                       initial_estimator_;
  boost::shared_ptr<pairs_uav_managers::StateEstimator>                       active_estimator_;
  ...
  boost::shared_ptr<pairs_uav_managers::AglEstimator>                       est_alt_agl_;
  bool                                                                    is_using_agl_estimator_;

  double max_flight_z_;

  bool switchToHealthyEstimator();
  void switchToEstimator(const boost::shared_ptr<pairs_uav_managers::StateEstimator>& target_estimator);
...
void EstimationManager::timerPublish([[maybe_unused]] const ros::TimerEvent& event) {
  ...
  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer("EstimationManager::timerPublish", ch_->scope_timer.logger, ch_->scope_timer.enabled);
  ...
  pairs_msgs::Float64Stamped agl_height;
...
void EstimationManager::timerPublishDiagnostics([[maybe_unused]] const ros::TimerEvent& event) {
  ...
  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer("EstimationManager::timerPublishDiagnostics", ch_->scope_timer.logger, ch_->scope_timer.enabled);
  ...
  pairs_msgs::Float64Stamped max_flight_z_msg;
  ...
  // publish diagnostics
  pairs_msgs::EstimationDiagnostics diagnostics;
...
void EstimationManager::timerCheckHealth([[maybe_unused]] const ros::TimerEvent& event) {
  ...
  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer("EstimationManager::timerCheckHealth", ch_->scope_timer.logger, ch_->scope_timer.enabled);
...
void EstimationManager::timerInitialization([[maybe_unused]] const ros::TimerEvent& event) {
  ...
  pairs_lib::ParamLoader param_loader(nh_, getName());
  ...
  ch_->transformer = std::make_shared<pairs_lib::Transformer>(nh_, getName());
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::HwApiCapabilities> sh_hw_api_capabilities_ =
      pairs_lib::SubscribeHandler<pairs_msgs::HwApiCapabilities>(shopts, "hw_api_capabilities_in");
  ...
  pairs_msgs::HwApiCapabilitiesConstPtr hw_api_capabilities = sh_hw_api_capabilities_.getMsg();
  /*//}*/
  ...
  pairs_msgs::ControlManagerDiagnosticsConstPtr control_manager_diag_msg = sh_control_manager_diag_.getMsg();
  ...
  for (auto estimator : estimator_list_) {
    ...
    ph->param_loader   = std::make_unique<pairs_lib::ParamLoader>(ros::NodeHandle(nh_, estimator->getName()), "EstimationManager/" + estimator->getName());
  ...
  if (is_using_agl_estimator_) {
    ...
    ph->loadConfigFile = boost::bind(&EstimationManager::loadConfigFile, this, _1);
    ph->param_loader   = std::make_unique<pairs_lib::ParamLoader>(ros::NodeHandle(nh_, est_alt_agl_->getName()), "EstimationManager/" + est_alt_agl_->getName());
  ...
  ph_uav_state_    = pairs_lib::PublisherHandler<pairs_msgs::UavState>(nh_, "uav_state_out", 10);
  ph_odom_main_    = pairs_lib::PublisherHandler<nav_msgs::Odometry>(nh_, "odom_main_out", 10);
  ph_innovation_   = pairs_lib::PublisherHandler<nav_msgs::Odometry>(nh_, "innovation_out", 10);
  ph_diagnostics_  = pairs_lib::PublisherHandler<pairs_msgs::EstimationDiagnostics>(nh_, "diagnostics_out", 10);
  ph_max_flight_z_ = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh_, "max_flight_z_agl_out", 10);
  ph_altitude_agl_ = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh_, "height_agl_out", 10);
  ...
  ch_->scope_timer.logger                = std::make_shared<pairs_lib::ScopeTimerLogger>(time_logger_filepath, ch_->scope_timer.enabled);
  /*//}*/
...
bool EstimationManager::callbackChangeEstimator(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res) {
  ...
  boost::shared_ptr<pairs_uav_managers::StateEstimator> target_estimator;
  for (auto estimator : estimator_list_) {
...
bool EstimationManager::callbackResetEstimator(pairs_msgs::String::Request& req, pairs_msgs::String::Response& res) {
...
/*//{ switchToEstimator() */
void EstimationManager::switchToEstimator(const boost::shared_ptr<pairs_uav_managers::StateEstimator>& target_estimator) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_managers::estimation_manager::EstimationManager, nodelet::Nodelet)
