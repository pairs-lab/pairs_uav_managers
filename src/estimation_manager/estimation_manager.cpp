...
public:
  ...
  bool isInState(const SMState_t &state) const {
    return pairs_lib::get_mutexed(mtx_state_, current_state_) == state;
  }

  bool isInitialized() const {
    return pairs_lib::get_mutexed(mtx_state_, current_state_) != UNINITIALIZED_STATE;
  }

  bool isInPublishableState() const {
    const SMState_t current_state = pairs_lib::get_mutexed(mtx_state_, current_state_);
  ...
  SMState_t getCurrentState() const {
    return pairs_lib::get_mutexed(mtx_state_, current_state_);
  }

  std::string getCurrentStateString() const {
    return pairs_lib::get_mutexed(mtx_state_, sm_state_names_[current_state_]);
  }
...
class EstimationManager : public pairs_lib::Node {

private:
  const std::string nodelet_name_ = "EstimationManager";
  const std::string package_name_ = "pairs_uav_managers";
  ...
  pairs_lib::PublisherHandler<pairs_msgs::msg::EstimationDiagnostics> ph_diagnostics_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>        ph_max_flight_z_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::UavState>              ph_uav_state_;
  pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>              ph_odom_main_;
  pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>              ph_odom_slow_; // use topic throttler instead?
  pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>              ph_innovation_;

  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped> ph_altitude_amsl_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped> ph_altitude_agl_;
  ...
  pairs_lib::Task<>            timerCheckHealth();
  ...
  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String> srvs_change_estimator_;
  bool callbackChangeEstimator(const std::shared_ptr<pairs_msgs::srv::String::Request> request, const std::shared_ptr<pairs_msgs::srv::String::Response> response);
  int  estimator_switch_count_ = 0;

  pairs_lib::ServiceServerHandler<pairs_msgs::srv::String> srvs_reset_estimator_;
  bool callbackResetEstimator(const std::shared_ptr<pairs_msgs::srv::String::Request> request, const std::shared_ptr<pairs_msgs::srv::String::Response> response);

  pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv> srvs_set_world_origin_;
  pairs_lib::Task<bool> callbackSetWorldOrigin(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                             const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response);

  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool> srvs_toggle_callbacks_;
  ...
  pairs_lib::Task<bool>                                   callFailsafeService();
  pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger> srvch_failsafe_;
  bool                                                  failsafe_call_succeeded_ = false;

  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv> srvch_set_world_origin_;
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv> srvch_update_sa_mgr_world_origin_;

  // | ------------- dynamic loading of estimators ------------- |

  std::unique_ptr<pluginlib::ClassLoader<pairs_uav_managers::StateEstimator>> state_estimator_loader_; // pluginlib loader of dynamically loaded estimators
  std::vector<std::string>                                                  estimator_names_;        // list of estimator names
  std::vector<std::shared_ptr<pairs_uav_managers::StateEstimator>>            estimator_list_;         // list of estimators
  ...
  std::shared_ptr<pairs_uav_managers::StateEstimator>                         initial_estimator_;
  std::shared_ptr<pairs_uav_managers::StateEstimator>                         active_estimator_;
  std::mutex                                                                mutex_active_estimator_;

  std::unique_ptr<pluginlib::ClassLoader<pairs_uav_managers::AglEstimator>> agl_estimator_loader_; // pluginlib loader of dynamically loaded estimators
  std::string                                                             est_alt_agl_name_ = "UNDEFINED_AGL_ESTIMATOR";
  std::shared_ptr<pairs_uav_managers::AglEstimator>                         est_alt_agl_;
  bool                                                                    is_using_agl_estimator_;

  double max_flight_z_;

  bool switchToHealthyEstimator();
  void switchToEstimator(const std::shared_ptr<pairs_uav_managers::StateEstimator> &target_estimator);
...
EstimationManager::EstimationManager(rclcpp::NodeOptions options) : pairs_lib::Node("estimation_manager", options) {

  node_  = this_node_ptr();
  clock_ = node_->get_clock();

  error_publisher_  = std::make_unique<pairs_lib::errorgraph::ErrorPublisher>(node_, clock_, "EstimationManager", "main");
...
void EstimationManager::initialize() {
  ...
  if (Support::toLowercase(world_origin_units) == "utm") {
    ...
    is_origin_param_ok &= param_loader.loadParam("pairs_uav_managers/world_origin/origin_x", world_origin_x);
    is_origin_param_ok &= param_loader.loadParam("pairs_uav_managers/world_origin/origin_y", world_origin_y);

  } else if (Support::toLowercase(world_origin_units) == "latlon") {
    double lat, lon;
    RCLCPP_INFO(node_->get_logger(), "Loading world origin in LatLon units.");
    is_origin_param_ok &= param_loader.loadParam("pairs_uav_managers/world_origin/origin_x", lat);
    is_origin_param_ok &= param_loader.loadParam("pairs_uav_managers/world_origin/origin_y", lon);
    pairs_lib::UTM(lat, lon, &world_origin_x, &world_origin_y);
  ...
  /*//{ load tracker names */
  param_loader.loadParam("pairs_uav_managers/uav_manager/takeoff/during_takeoff/tracker", takeoff_tracker_name_);
  param_loader.loadParam("pairs_uav_managers/uav_manager/midair_activation/after_activation/tracker", after_midair_activation_tracker_name_);
  /*//}*/
  ...
  ch_->transformer = std::make_shared<pairs_lib::Transformer>(node_);
  ...
  pairs_msgs::msg::HwApiCapabilities::ConstSharedPtr hw_api_capabilities = sh_hw_api_capabilities_.getMsg();
  ...
  if (!sh_control_manager_diag_.hasMsg()) {
    ...
    pairs_msgs::msg::ControlManagerDiagnostics::ConstSharedPtr control_manager_diag_msg = sh_control_manager_diag_.getMsg();
  ...
  state_estimator_loader_ = std::make_unique<pluginlib::ClassLoader<pairs_uav_managers::StateEstimator>>("pairs_uav_managers", "pairs_uav_managers::StateEstimator");
  ...
  if (is_using_agl_estimator_) {
    ...
    agl_estimator_loader_ = std::make_unique<pluginlib::ClassLoader<pairs_uav_managers::AglEstimator>>("pairs_uav_managers", "pairs_uav_managers::AglEstimator");
  ...
  for (auto estimator : estimator_list_) {
    ...
    std::shared_ptr<pairs_uav_managers::estimation_manager::PrivateHandlers_t> ph = std::make_shared<pairs_uav_managers::estimation_manager::PrivateHandlers_t>();

    ph->loadConfigFile = std::bind(&EstimationManager::loadConfigFile, this, std::placeholders::_1);
    ph->param_loader   = std::make_unique<pairs_lib::ParamLoader>(subnode, estimator->getName());
  ...
  if (is_using_agl_estimator_) {
    ...
    ph->loadConfigFile = std::bind(&EstimationManager::loadConfigFile, this, std::placeholders::_1);
    ph->param_loader   = std::make_unique<pairs_lib::ParamLoader>(subnode, est_alt_agl_->getName());
    ph->param_loader->copyYamls(param_loader);
    ph->param_loader->setPrefix(ch_->package_name + "/" + Support::toSnakeCase(ch_->nodelet_name) + "/");
  ...
  ph_uav_state_    = pairs_lib::PublisherHandler<pairs_msgs::msg::UavState>(node_, "~/uav_state_out");
  ph_odom_main_    = pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>(node_, "~/odom_main_out");
  ph_innovation_   = pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>(node_, "~/innovation_out");
  ph_diagnostics_  = pairs_lib::PublisherHandler<pairs_msgs::msg::EstimationDiagnostics>(node_, "~/diagnostics_out");
  ph_max_flight_z_ = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/max_flight_z_agl_out");
  ph_altitude_agl_ = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/height_agl_out");
  ...
  pairs_lib::TimerHandlerOptions opts_co;
  ...
  srvch_failsafe_                   = pairs_lib::ServiceClientHandler<std_srvs::srv::Trigger>(node_, "~/failsafe_out", cbkgrp_sc_);
  srvch_set_world_origin_           = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/set_world_origin_out", cbkgrp_sc_);
  srvch_update_sa_mgr_world_origin_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::ReferenceStampedSrv>(node_, "~/update_world_origin_out", cbkgrp_sc_);

  /*//}*/

  /*//{ initialize service servers */

  srvs_change_estimator_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(
  ...
  srvs_reset_estimator_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::String>(
      node_, "~/reset_estimator_in", std::bind(&EstimationManager::callbackResetEstimator, this, std::placeholders::_1, std::placeholders::_2),
      rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  srvs_set_world_origin_ = pairs_lib::ServiceServerHandler<pairs_msgs::srv::ReferenceStampedSrv>(
      node_, "~/set_world_origin_in", &EstimationManager::callbackSetWorldOrigin, this, rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  srvs_toggle_callbacks_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
  ...
  ch_->scope_timer.logger                = std::make_shared<pairs_lib::ScopeTimerLogger>(node_, time_logger_filepath, ch_->scope_timer.enabled);
...
void EstimationManager::timerPublish() {
  ...
  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer(node_, "EstimationManager::timerPublish", ch_->scope_timer.logger, ch_->scope_timer.enabled);
  ...
  pairs_msgs::msg::UavState uav_state;
  ...
  pairs_msgs::msg::Float64Stamped agl_height;
...
void EstimationManager::timerPublishDiagnostics() {
  ...
  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer(node_, "EstimationManager::timerPublishDiagnostics", ch_->scope_timer.logger, ch_->scope_timer.enabled);
  ...
  pairs_msgs::msg::Float64Stamped max_flight_z_msg;
  ...
  // publish diagnostics
  pairs_msgs::msg::EstimationDiagnostics diagnostics;
...
pairs_lib::Task<> EstimationManager::timerCheckHealth() {

  if (!sm_->isInitialized()) {
    co_return;
  }

  pairs_lib::ScopeTimer scope_timer = pairs_lib::ScopeTimer(node_, "EstimationManager::timerCheckHealth", ch_->scope_timer.logger, ch_->scope_timer.enabled);
...
bool EstimationManager::callbackChangeEstimator(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
  ...
  std::shared_ptr<pairs_uav_managers::StateEstimator> target_estimator;
  for (auto estimator : estimator_list_) {
...
bool EstimationManager::callbackResetEstimator(const std::shared_ptr<pairs_msgs::srv::String::Request>  request,
                                               const std::shared_ptr<pairs_msgs::srv::String::Response> response) {
...
pairs_lib::Task<bool> EstimationManager::callbackSetWorldOrigin(const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Request>  request,
                                                              const std::shared_ptr<pairs_msgs::srv::ReferenceStampedSrv::Response> response) {
...
void EstimationManager::switchToEstimator(const std::shared_ptr<pairs_uav_managers::StateEstimator> &target_estimator) {
...
pairs_lib::Task<bool> EstimationManager::callFailsafeService() {
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_managers::estimation_manager::EstimationManager)
