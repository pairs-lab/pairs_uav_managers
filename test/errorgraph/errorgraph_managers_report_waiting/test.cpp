...
private:
  struct ManagerState
  {
    std::optional<pairs_msgs::msg::ErrorgraphElement> last_msg;
  ...
  rclcpp::Subscription<pairs_msgs::msg::ErrorgraphElement>::SharedPtr sub_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  sub_ = node_->create_subscription<pairs_msgs::msg::ErrorgraphElement>(topic_name_, 100,
                                                                      [this](const pairs_msgs::msg::ErrorgraphElement::SharedPtr msg) { errorsCallback(msg); });
}
