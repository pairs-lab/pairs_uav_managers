...
public:
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::ConstraintsOverride> sch_override_constraints_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  sch_override_constraints_ = pairs_lib::ServiceClientHandler<pairs_msgs::ConstraintsOverride>(nh_, "/" + _uav_name_ + "/constraint_manager/constraints_override");
}
...
bool Tester::test() {
  ...
  {
    pairs_msgs::ConstraintsOverride srv;
