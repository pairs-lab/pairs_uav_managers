...
public:
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::Float64Srv> sch_set_ground_z_;
};

Tester::Tester() {

  sch_set_ground_z_ = pairs_lib::ServiceClientHandler<pairs_msgs::Float64Srv>(nh_, "/multirotor_simulator/uav1/set_ground_z");
}
...
bool Tester::test() {
  ...
  auto takeoff_hdg = pairs_lib::AttitudeConverter(uh->sh_uav_state_.getMsg()->pose.orientation).getHeading();
