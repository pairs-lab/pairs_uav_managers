...
public:
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::Float64Srv> sch_set_mass_;
};

Tester::Tester() : pairs_uav_testing::TestGeneric() {

  sch_set_mass_ = pairs_lib::ServiceClientHandler<pairs_msgs::Float64Srv>(nh_, "/multirotor_simulator/uav1/set_mass");
}
