...
public:
  Tester() : pairs_uav_testing::TestGeneric() {
    ...
    sch_set_mass_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::Float64Srv>(node_, "/multirotor_simulator/uav1/set_mass");
  }

  pairs_lib::ServiceClientHandler<pairs_msgs::srv::Float64Srv> sch_set_mass_;
