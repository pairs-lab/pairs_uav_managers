...
public:
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv> sch_land_there_;
...
Tester::Tester() {
  ...
  sch_land_there_ = pairs_lib::ServiceClientHandler<pairs_msgs::ReferenceStampedSrv>(nh_, "/" + _uav_name_ + "/uav_manager/land_there");
}
