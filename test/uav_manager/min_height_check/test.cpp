...
public:
  Tester() : pairs_uav_testing::TestGeneric() {
    ...
    sch_min_height_check_ = pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool>(node_, "/" + _uav_name_ + "/uav_manager/enable_min_height_check");
  }
  ...
  pairs_lib::ServiceClientHandler<std_srvs::srv::SetBool> sch_min_height_check_;
...
bool Tester::test(void) {
  ...
  pl_->loadParam("pairs_uav_managers/uav_manager/min_height_checking/safety_height_offset", _min_height_offset_);
  pl_->loadParam("pairs_uav_managers/uav_manager/min_height_checking/min_height", _min_height_);
