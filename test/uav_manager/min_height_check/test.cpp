...
public:
  ...
  pairs_lib::ServiceClientHandler<std_srvs::SetBool> sch_min_height_check_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  sch_min_height_check_ = pairs_lib::ServiceClientHandler<std_srvs::SetBool>(nh_, "/" + _uav_name_ + "/uav_manager/enable_min_height_check");
}
