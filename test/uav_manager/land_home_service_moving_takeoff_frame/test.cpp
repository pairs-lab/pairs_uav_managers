...
public:
  Tester() : pairs_uav_testing::TestGeneric() {
    ...
    sch_set_ground_z_ = pairs_lib::ServiceClientHandler<pairs_msgs::srv::Float64Srv>(node_, "/multirotor_simulator/uav1/set_ground_z");
  }
  ...
  pairs_lib::ServiceClientHandler<pairs_msgs::srv::Float64Srv> sch_set_ground_z_;
...
bool Tester::asyncSetGroundZ() {
  ...
  std::shared_ptr<pairs_msgs::srv::Float64Srv::Request> request = std::make_shared<pairs_msgs::srv::Float64Srv::Request>();
