...
public:
  Tester() : pairs_uav_testing::TestGeneric() {
    ...
    sh_hw_api_odom_ =
        pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(*shopts_, "/" + _uav_name_ + "/hw_api/odometry_unchanged", &Tester::callbackOdometry, this);

    ph_odometry_ = pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>(node_, "/" + _uav_name_ + "/hw_api/odometry");
  }

  const std::string _uav_name_ = "uav1";

  pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry> sh_hw_api_odom_;
