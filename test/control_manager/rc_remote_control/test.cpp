...
bool Tester::getControllerDynamics(double &horizontal_speed, double &vertical_speed, double &heading_rate) {
  ...
  pl_->loadParam("pairs_uav_managers/control_manager/rc_joystick/horizontal_speed", horizontal_speed);
  pl_->loadParam("pairs_uav_managers/control_manager/rc_joystick/vertical_speed", vertical_speed);
  pl_->loadParam("pairs_uav_managers/control_manager/rc_joystick/heading_rate", heading_rate);
