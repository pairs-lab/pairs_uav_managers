...
public:
  ...
  pairs_lib::PublisherHandler<pairs_msgs::msg::ObstacleSectors> ph_bumper_;

  std::shared_ptr<TimerType> timer_bumper_;
  void                       timerBumper();

  pairs_msgs::msg::ObstacleSectors bumper_data_;
  ...
  pairs_msgs::msg::HwApiRcChannels rc_;
  std::mutex                     mutex_rc_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  ph_bumper_ = pairs_lib::PublisherHandler<pairs_msgs::msg::ObstacleSectors>(node_, "/" + _uav_name_ + "/bumper/obstacle_sectors");
  ...
  ph_rc_channels_ = pairs_lib::PublisherHandler<pairs_msgs::msg::HwApiRcChannels>(node_, "/" + _uav_name_ + "/hw_api/rc_channels");
...
void Tester::timerBumper() {
  ...
  auto bumper_data = pairs_lib::get_mutexed(mutex_bumper_data_, bumper_data_);
