...
public:
  ...
  pairs_lib::ServiceClientHandler<std_srvs::Trigger> sch_esc_failsafe_;
...
Tester::Tester() {
  ...
  sch_esc_failsafe_ = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "/" + _uav_name_ + "/control_manager/failsafe_escalating");
}
