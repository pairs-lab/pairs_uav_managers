...
def generate_test_description():
    ...
    network_config=get_package_share_directory("pairs_uav_testing")+"/config/default_network_config.yaml",
    world_config=get_package_share_directory("pairs_uav_testing")+"/config/default_world_config.yaml",
    platform_config=get_package_share_directory("pairs_multirotor_simulator")+"/config/pairs_uav_system/x500.yaml",
    ...
    ld.add_action(
        GroupAction([
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource([
                    PathJoinSubstitution([
                        FindPackageShare('pairs_uav_managers'),
                            'launch',
