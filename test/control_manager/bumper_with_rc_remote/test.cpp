...
private:
  pairs_lib::PublisherHandler<pairs_msgs::ObstacleSectors> ph_bumper_;
  ...
  pairs_msgs::ObstacleSectors bumper_data_;
  ...
  pairs_msgs::HwApiRcChannels rc_;
  std::mutex                mutex_rc_;
...
Tester::Tester() : pairs_uav_testing::TestGeneric() {
  ...
  ph_bumper_ = pairs_lib::PublisherHandler<pairs_msgs::ObstacleSectors>(nh_, "/" + _uav_name_ + "/bumper/obstacle_sectors");
  ...
  ph_rc_channels_ = pairs_lib::PublisherHandler<pairs_msgs::HwApiRcChannels>(nh_, "/" + _uav_name_ + "/hw_api/rc_channels");
