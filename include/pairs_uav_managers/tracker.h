...
public:
   ...
   */
  virtual std::tuple<bool, std::string> activate(const std::optional<pairs_msgs::msg::TrackerCommand> &last_tracker_cmd) = 0;
   ...
   */
  virtual const std::shared_ptr<std_srvs::srv::Trigger::Response> switchOdometrySource(const pairs_msgs::msg::UavState &new_uav_state) = 0;
   ...
   */
  virtual std::optional<pairs_msgs::msg::TrackerCommand> update(const pairs_msgs::msg::UavState   &uav_state,
   ...
   */
  virtual const pairs_msgs::msg::TrackerStatus getStatus() = 0;
   ...
   * @return a service response
   */
  virtual const std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Response> setReference(const std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Request> &request) = 0;
   ...
   * @return a service response
   */
  virtual const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Response>
  setVelocityReference(const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Request> &request) = 0;
   ...
   * @return a service response
   */
  virtual const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Response>
  setTrajectoryReference(const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request> &request) = 0;
