#ifndef PAIRS_UAV_MANAGERS_STATE_ESTIMATOR_H
#define PAIRS_UAV_MANAGERS_STATE_ESTIMATOR_H
...
protected:
  ...
  pairs_msgs::msg::UavState uav_state_init_;
  ...
  pairs_msgs::msg::Float64ArrayStamped pose_covariance_, twist_covariance_;
...
protected:
  mutable pairs_lib::PublisherHandler<pairs_msgs::msg::UavState>               ph_uav_state_;
  mutable pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>               ph_odom_;
  mutable pairs_lib::PublisherHandler<pairs_msgs::msg::Float64ArrayStamped>    ph_pose_covariance_, ph_twist_covariance_;
  mutable pairs_lib::PublisherHandler<nav_msgs::msg::Odometry>               ph_innovation_;
  mutable pairs_lib::PublisherHandler<geometry_msgs::msg::QuaternionStamped> ph_attitude_;
...
public:
  ...
  virtual bool setUavState(const pairs_msgs::msg::UavState &uav_state) = 0;

  virtual void updateUavState() = 0;

  // implemented methods
  std::optional<pairs_msgs::msg::UavState>        getUavState();
...
#endif // PAIRS_UAV_MANAGERS_STATE_ESTIMATOR_H
