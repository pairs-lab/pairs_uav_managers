...
#include <pairs_msgs/EstimatorDiagnostics.h>
...
protected:
  mutable pairs_lib::PublisherHandler<pairs_msgs::EstimatorDiagnostics> ph_diagnostics_;
...
public:
  ...
  tf2::Vector3          getAccGlobal(const pairs_msgs::EstimatorInput::ConstPtr &input_msg, const double hdg);
