...
public:
  ...
  static tf2::Vector3 rotateVecByHdg(const geometry_msgs::msg::Vector3 &vec_in, const double hdg_in) {
    ...
    const tf2::Quaternion q_hdg = pairs_lib::AttitudeConverter(0, 0, 0).setHeading(hdg_in);
  ...
  static geometry_msgs::msg::Vector3 rotateVector(const geometry_msgs::msg::Vector3 &vec_in, const geometry_msgs::msg::Quaternion &q_in) {
    ...
    try {
      Eigen::Matrix3d R = pairs_lib::AttitudeConverter(q_in);
  ...
  static nav_msgs::msg::Odometry uavStateToOdom(const pairs_msgs::msg::UavState &uav_state) {
    ...
    odom.twist.twist.linear = Support::rotateVector(uav_state.velocity.linear, pairs_lib::AttitudeConverter(q.inverse()));
